<?php
	...
	class WPBakeryShortCode_postgallery_grid extends WPBakeryShortCode { // WPBakeryShortCode_ PREFIX REQUIRED 
		...
		protected function content( $atts, $content = null )
		{
			...
			$attributes = 'content:'. $acoda_groupgridcontent .'|excerpt:'. $acoda_galleryexcerpt . '|lightbox:'. $acoda_lightbox . '|img_size:'. $img_size. '|imageeffect:'. $acoda_imageeffect. '|hover_effect:'. $hover_effect.'|title_size:'. $title_size.'|gallery_id:'.$acoda_shortcode_id. '|product_price:'. $product_price. '|post_date:'. $post_date. '|post_author:'. $post_author. '|post_category:'. $post_category;		
	...
	vc_map( array(
		...
		"params"	=> array(									
			...
			array(
				...
				"class" => "",
				'group' => esc_html__('Text', 'dynamix'),
				"heading" => esc_html__("Title Excerpt", 'dynamix'),
			...
			array(
				'type' => 'dropdown',
				'group' => esc_html__('Text', 'dynamix'),
				'heading' => esc_html__( 'Horizontal Text Align', 'dynamix' ),
			...
			array(
				'type' => 'dropdown',
				'group' => esc_html__('Text', 'dynamix'),
				'heading' => esc_html__( 'Vertical Text Align', 'dynamix' ),
			...
			array(
				'type' => 'checkbox',
				'heading' => esc_html__( 'Post Category', 'dynamix' ),
			...
			/*array(
				...
				"group" => esc_html__('Overlay & Hover', 'dynamix')
			),*/	
			array(
				"type" => "dropdown",
				"heading" => esc_html__("Hover Effect", 'dynamix'),
			...
			array(
				"type" => "dropdown",
				"class" => "",
				"heading" => esc_html__("Grid Style", 'dynamix'),
				"param_name" => "masonry",
				"value" => array( 
					esc_html__("Normal", 'dynamix') => '',
					esc_html__("Masonry", 'dynamix') => 'masonry',
					esc_html__("Grid Block 1", 'dynamix') => 'masonry_style_1',	
					esc_html__("Grid Block 2", 'dynamix') => 'masonry_style_2',	
				),
			),		
			...
			array(
				...
				"value" => array( 
					...
					esc_html__("5px", 'dynamix') => 'column_padding_5',
					esc_html__("10px", 'dynamix') => 'column_padding_10',
					esc_html__("15px", 'dynamix') => 'column_padding',
					esc_html__("20px", 'dynamix') => 'column_padding_20',
					esc_html__("30px", 'dynamix') => 'column_padding_30',
				),
			),		
			array(
				"type" => "dropdown",
			...
			array(
				...
				"value" => array( 
					esc_html__("Solid", 'dynamix') => 'enable',
					esc_html__("Gradient", 'dynamix') => 'gradient',
			...
			array(
				...
				"dependency" => Array('element' => 'hover_overlay', 'value' => array('enable','gradient') ),
				"value" => 'rgba(0,0,0,0.2)'
			),
			array(
				"type" => "colorpicker",
				'group' => esc_html__('Overlay & Hover', 'dynamix'),
				"heading" => esc_html__('Overlay Secondary Color', 'dynamix'),
				"param_name" => "overlay_color_sec",
				"dependency" => Array('element' => 'hover_overlay', 'value' => 'gradient' ),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__( 'Element Animation', 'dynamix' ),
				'param_name' => 'paroller_type',
				'value' => array(
					esc_html__( 'Group', 'dynamix' ) => 'group',
					esc_html__( 'Individual', 'dynamix' ) => 'individual',
				),
				'group' => esc_html__( 'Parallax', 'dynamix' )
			),		
			array(
