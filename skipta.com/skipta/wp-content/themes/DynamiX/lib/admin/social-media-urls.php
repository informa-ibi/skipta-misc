<?php
	...
	$sociallink_fb = 'http://www.facebook.com/sharer.php?u=[get_permalink]&amp;t=[get_the_title]&amp;popup=yes';	
	}
	
	if(of_get_option('sociallink_linkedin')) {
	$sociallink_linkedin = of_get_option('sociallink_linkedin');	
	} else {
	$sociallink_linkedin = 'http://www.linkedin.com/shareArticle?mini=true&url=[get_permalink]&title=[get_the_title]&source=[get_blogurl]&amp;popup=yes';	
	}
	...
	$sociallink_twitter = 'http://twitter.com/share?text=[get_the_title]&amp;url=[get_permalink]&amp;popup=yes';	
	}
	
	if(of_get_option('sociallink_google')) {
	$sociallink_google = of_get_option('sociallink_google');	
	} else {
	$sociallink_google = 'https://plus.google.com/share?url=[get_permalink]&amp;popup=yes';	
	}
	...
	if(of_get_option('sociallink_vine')) {
	$sociallink_vine = of_get_option('sociallink_vine');	
	} else {
	$sociallink_vine = 'https://vine.co/';	
	}		
	
	if(of_get_option('sociallink_vk')) {
	$sociallink_vk = of_get_option('sociallink_vk');	
	} else {
	$sociallink_vk = 'http://vk.com/share.php?url=[get_permalink]&amp;popup=yes';	
	}	
	
	if(of_get_option('sociallink_xing')) {
	$sociallink_xing = of_get_option('sociallink_xing');	
	} else {
	$sociallink_xing = 'https://www.xing.com/spi/shares/new?url=[get_permalink]&amp;popup=yes';	
	}	

	if(of_get_option('sociallink_tumblr')) {
	$sociallink_tumblr = of_get_option('sociallink_tumblr');	
	} else {
	$sociallink_tumblr = 'http://tumblr.com/widgets/share/tool?canonicalUrl=[get_permalink]&amp;popup=yes';	
	}	
	
	if(of_get_option('sociallink_dribbble')) {
	$sociallink_dribbble = of_get_option('sociallink_dribbble');	
	} else {
	$sociallink_dribbble = 'https://dribbble.com/';	
	}		*/				
