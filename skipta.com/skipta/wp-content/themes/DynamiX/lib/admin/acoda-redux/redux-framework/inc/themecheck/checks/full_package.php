    ...
    class Redux_Full_Package implements themecheck {
        ...
        function check( $php_files, $css_files, $other_files ) {
            ...
            if ( $redux ) {
                ...
                $blacklist = array(
                    '.tx'                    => __( 'Redux localization utilities', 'dynamix' ),
                    'bin'                    => __( 'Redux Resting Diles', 'dynamix' ),
                    'codestyles'             => __( 'Redux Code Styles', 'dynamix' ),
                    'tests'                  => __( 'Redux Unit Testing', 'dynamix' ),
                    'class.redux-plugin.php' => __( 'Redux Plugin File', 'dynamix' ),
                    'bootstrap_tests.php'    => __( 'Redux Boostrap Tests', 'dynamix' ),
                    '.travis.yml'            => __( 'CI Testing FIle', 'dynamix' ),
                    'phpunit.xml'            => __( 'PHP Unit Testing', 'dynamix' ),
                );
