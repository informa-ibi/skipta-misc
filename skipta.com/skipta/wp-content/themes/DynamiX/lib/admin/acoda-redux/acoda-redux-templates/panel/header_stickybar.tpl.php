...
<div id="redux-sticky">
    <div id="info_bar">
		...
		<div class="acoda-support">
			<a href="http://acoda.com/forums" target="_blank"><span class="nc-icon-outline  objects_support-17"></span><?php esc_attr_e( 'Support Center', 'dynamix' ); ?></a>
		</div>
