...
<div class="redux-sidebar">
	<div class="acoda-header">
    	<a href="http://acoda.com" target="_blank"><img src="<?php echo get_template_directory_uri() . '/lib/admin/assets/images/acoda.png'; ?>" /></a>
    	<h2><?php echo wp_kses_post( $this->parent->args['display_name'] ); ?></h2>
		<?php if ( ! empty( $this->parent->args['display_version'] ) ) { ?>
                <span class="version"><?php echo wp_kses_post( $this->parent->args['display_version'] ); ?></span>
		<?php } ?>
    </div>
