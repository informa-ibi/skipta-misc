 ...
 */
$type = $icon_fontawesome = $icon_nucleo_outline = $icon_nucleo_glyph = $icon_openiconic = $icon_typicons =
...
?>
<div class="vc_icon_element vc_icon_element-outer<?php echo strlen( $css_class ) > 0 ? ' ' . trim( esc_attr( $css_class ) ) : ''; ?> vc_icon_element-align-<?php echo esc_attr( $align ); ?><?php if ( $has_style ): echo ' vc_icon_element-have-style'; endif; ?>">
    ...
    <span class="vc_icon_element-icon <?php echo esc_attr( $iconClass ); ?>" <?php echo( $color === 'custom' ? 'style="color:' . esc_attr( $custom_color ) . ' !important"' : '' ); ?>></span>
		<?php
