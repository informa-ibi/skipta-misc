        ...
        _convertStyledBoxColumns:function (layout) {
            ...
            _.each(layout_split, function (value, i) {
                ...
                vc.storage.lock();
				  ...
				  new_column = Shortcodes.create({shortcode:( this.model.get('shortcode')==='styledbox' ?  'vc_column_inner' : 'vc_column'), params:new_column_params, parent_id:this.model.id}); // _acoda_mod added: || this.model.get('shortcode')==='styledbox'              	  
