...
<div  class="poststreamwidget" id="groupFormDiv" >
 ...
 <div class="row-fluid  customrow-fluid" >
    ...
    <div id="editable"  placeholder="New Post" class="placeholder inputor" data-type="group" contentEditable="true" <?php if($DisableWebPreview==0){?> onkeyup="getsnipetForGroup(event,this);" <?php }?>  onblur="validateDescription(this)"></div>
    <div class="control-group controlerror">  
...
<?php  }?>
   ...
   <?php   echo $form->error($groupPostModel, 'Artifacts'); ?>
    ...
    <div class="pull-right">
         <?php   echo CHtml::Button('Post',array('class' => 'btn','onclick'=>'groupsend('.$IsPrivateGroup.');')); ?> 
