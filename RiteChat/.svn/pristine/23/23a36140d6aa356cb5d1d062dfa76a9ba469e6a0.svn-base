                            ...
                            <div id="addNewNetworkParameterSpinLoader"></div>
                                <div class="signdiv">
                                    ...
                                    <div class="headerbuttonpopup h_center padding8top">
                                        <?php echo CHtml::Button('Save', array('onclick' => 'saveParameterForm()', 'class' => 'btn btn-2 btn-2a pull-right', 'id' => 'newNetworkParameter')); ?> 
                                        
                                    </div>
                                    <?php echo CHtml::resetButton('Clear', array("id" => 'networkParameterReset', "style" => "display:none")); ?>
