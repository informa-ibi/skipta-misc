...
<div class="qusetiondisclaimer" style="<?php if(trim($question['OptionBDisclaimer'])=="" || $disclaimer ==0){?> display:none<?php }?>">
  ...
  <div class="disclaimertext"><span>Option Disclaimer</span> <?php echo $question['OptionADisclaimer']?></div>
  
  </div>
  </div>
      <div class="span6" >
  <div class="questiondiv positionrelative" style="display: none" id="qDis_<?php echo $sno.'_B'?>">
  <div class="disclaimertext"><span>Option Disclaimer</span> <?php echo $question['OptionBDisclaimer']?></div>
...
<div class="qusetiondisclaimer" style="<?php if(trim($question['OptionDDisclaimer'])=="" || $disclaimer ==0){?> display:none<?php }?>">
  ...
  <div class="disclaimertext"><span>Option Disclaimer</span> <?php echo $question['OptionCDisclaimer']?></div>
  
  </div>
  </div>
      <div class="span6" >
  <div class="questiondiv positionrelative" style="display: none" id="qDis_<?php echo $sno.'_D'?>">
  <div class="disclaimertext"><span>Option Disclaimer</span> <?php echo $question['OptionDDisclaimer']?></div>
