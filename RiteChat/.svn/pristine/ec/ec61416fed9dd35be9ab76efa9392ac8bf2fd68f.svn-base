...
<div class="rightwidgettitle paddingt12">
        <i class="spriteicon"><img class="r_g_activity" src="/images/system/spacer.png"></i><span class="widgettitle">Group Activity</span>
    </div>
     ...
     <ul>
         <?php 
            foreach ($groupActivityList as $data) {
                ?>
         <li>
             <div name="GroupDetailInRightWidget" data-id="<?php echo$data->GroupId ?>" data-name="<?php echo$data->GroupName ?>"  style="cursor: pointer">
            ...
            if ($data->GroupIcon !='') {
                ?>
                  ...
                  <div class="media-body">
                      <div class="r_ga_content" ><?php echo $data->GroupName ?>
                  </div>
                  </div>
                 </div>
