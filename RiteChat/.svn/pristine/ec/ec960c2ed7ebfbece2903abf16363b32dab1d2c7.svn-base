...
<div class="stream_widget marginT10" >
    <div class="profile_icon"><img src="<?php if($data->isGroupAdminPost == 'true' && $data->ActionType=='Post') {
    ...
    <div class="post_widget" data-postid="<?php  echo $data->PostId ?>" data-postType="<?php  echo $data->PostType;?>">
        <div class="stream_msg_box">
            <div class="stream_title paddingt5lr10" style="position: relative"> 
                    ...
                    <a class="<?php if($data->isGroupAdminPost == 'true' && $data->ActionType=='Post') { echo 'grpIntro'; } else { echo 'userprofilename';} ?> " data-id="<?php if($data->isGroupAdminPost == 'true' && $data->ActionType=='Post') { echo $data->MainGroupId; } else { echo $data->FirstUserId; } ?>" style="cursor:pointer">
                    <b><?php if($data->isGroupAdminPost == 'true' && $data->ActionType=='Post') {
                           echo $data->GroupName; 
                        }else{
                            echo $data->FirstUserDisplayName;} ?></b></a><?php  echo $data->SecondUserData?> 
                        <?php  echo $data->StreamNote."  ".$data->PostTypeString ?> 
                <span class='userprofilename'> 
                    <?php if($data->PostType==2 || $data->PostType==3){ if(isset($data->Title) && $data->Title!=""){ echo "- ".$data->Title; };} ?>
                </span>  
                    <?php if ($data->PostType==5){echo "- ".$data->CurbsideConsultTitle ?> <i><?php  echo $data->PostOn; ?></i><?php }else{?><i><?php  echo $data->PostOn; ?></i><?php }?>
                ...
                <ul>
                    <li class="media">
                        ...
                        <div class="media-body" >
                            ...
                            <div id="EventpostDescription" style="<?php if($data->ArtifactIcon!=""){ echo 'display:block'; } else{ echo 'display:none';} ?>" >
                      ...
                      <div class="pull-left" >
                        ...
                        <div class="timeshow pull-left"  > 
                            ...
                            <div class="et_location clearboth"><span><i class="fa fa-map-marker"></i><?php  echo $data->Location ?></span> </div>
                             ...
                             <div id="EventpostDescriptionArtifact" style="<?php if ($data->ArtifactIcon != "") { echo 'display:none'; } else { echo 'display:block'; } ?>" >
                                <div class="media-body">
                                    <div class="bulletsShow" data-postid="<?php echo $data->PostId; ?>"  data-id="<?php echo $data->_id; ?>" data-categoryType="<?php echo $data->CategoryType; ?>" id="post_content_total_<?php echo $data->_id; ?>" style="display:none" >
                            ...
                            <div class="media-body"> <div class="media">
                                ...
                                <div class="media-body">                                   
                                    ...
                                    <div class="m_title"><a class="userprofilename" data-streamId="<?php echo $data->_id;?>" data-id="<?php  echo $data->OriginalUserId ?>"  style="cursor:pointer"><?php  echo '' ?></a><?php if ($data->PostType==5){?><div id="curbside_spinner_<?php echo $data->_id; ?>"></div><span class="pull-right" data-id="<?php echo $data->_id; ?>"><?php echo $data->CurbsideConsultCategory?></span><?php }?></div>
...
//                    }
                ?>
                      ...
                      <?php  if($data->PostType==2){ ?>      
                       ...
                       <?php }?>
                            ...
                            <?php } ?>  
                                    <a id="imgsingle_<?php echo $data->_id; ?>" class="pull-left img_single surveyimg <?php echo $className; ?>" data-id="<?php echo $data->_id;?>" data-postid="<?php echo $data->PostId;?>" data-categoryType="<?php echo $data->CategoryType;?>" data-postType="<?php echo $data->PostType;?>" data-videoimage="<?php echo $uri; ?>" data-vimage="<?php  echo $data->ArtifactIcon ?>"><div id='img_streamVideoDiv<?php echo $data->_id; ?>' class='<?php echo $videoclassName; ?>'><img src="/images/icons/video_icon.png"></div><img src="<?php  echo $data->ArtifactIcon ?>" <?php if(!empty($imageVideomp3Id)){ echo "id=$imageVideomp3Id"; }?>  ></a>
            ...
            <div class=" stream_content positionrelative">
                ...
                <ul>
                    <li class="media">
                        <a  class="pull-left img_single" href="/<?php echo $data->GroupName ?>/sg/<?php echo $data->SubGroupName ?>"><img src="<?php echo $data->SubGroupImage ?>"  ></a>
                        <div class="media-body" >
                            <p  data-postid="<?php echo $data->PostId; ?>">
                                <a href="/<?php echo $data->GroupName ?>/sg/<?php echo $data->SubGroupName ?>" ><b><?php echo $data->SubGroupName;?></b></a>
                            </p>
                        ...
                        <div class="social_bar" data-id="<?php  echo $data->_id ?>" data-subgroupid="<?php  echo $data->SubGroupId ?>" data-groupid="<?php  echo $data->GroupId ?>" data-postid="<?php  echo $data->PostId ?>" data-postType="<?php  echo $data->PostType;?>" data-categoryType="<?php  echo $data->CategoryType;?>" data-pagetype="Group" data-IsPrivate="<?php  echo $data->IsPrivate;?>">	
                            <a class="follow_a"><i><img src="/images/system/spacer.png"  class=" tooltiplink <?php  echo $data->IsFollowingEntity?'follow':'unfollow' ?>"  data-placement="bottom" rel="tooltip"  data-original-title="<?php  echo $data->IsFollowingEntity?'Unfollow':'Follow' ?>"></i></a><b id="group_followers_count_<?php  echo $data->_id ?>"><?php echo $data->SubGroupFollowersCount ?></b>
                        </div><?php } ?>
                    </li>
                </ul>
            </div>
        ...
        ?>
         ...
         <div class="viewmorecomments alignright">
           ...
           <div id="newComment_<?php echo $data->_id; ?>" style="display:none" class="paddinglrtp5">
                       <div id="commentTextArea_<?php echo $data->_id; ?>" class="inputor commentplaceholder" contentEditable="true" onkeyup="getsnipetForGroupComment(event,this,'<?php echo $data->_id; ?>');"  onclick="OpenCommentbuttonArea('<?php echo $data->_id; ?>','<?php echo $data->CategoryType; ?>')"></div>
...
<script type="text/javascript">
    ...
    <?php if($data->CategoryType !=7 && (!$data->DisableComments)){?> 
