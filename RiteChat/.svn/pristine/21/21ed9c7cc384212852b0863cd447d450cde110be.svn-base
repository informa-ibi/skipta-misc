            ...
            <div class="analytics_topleaders_box">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                     ...
                     <span class="">Group Engagement <i class="cursor helpmanagement" data-id="GroupEngagementHelpDescription_DivId"><img src="/images/system/spacer.png" /></i></span>
                                ...
                                <li style="cursor:pointer; position: relative" class="dropdown pull-left">
                                    ...
                                    <div class="dropdown-menu analytics_export_div">
                                        ...
                                        <ul>
                                            ...
                                            <li class="" ><a href="#"  target="_blank" onclick="openActivitypdf(this,'GroupEngagement')" id="groupEngagmentPdf" name="groupEngagmentPdf"><i><img src="/images/system/spacer.png"  class="pdf_doc"></i> Export as PDF</a></li>
                                            <li class="" ><a href="#"  onclick="openActivityXls(this,'GroupEngagement')" id="groupEngagementXls"  target="_blank"><i><img src="/images/system/spacer.png" class="excel_doc"></i> Export as Excel</a></li>
                                        </ul>
...
//              
   ...
   // var xyArray =  ['Year', 'Stream', 'Posts','Curbside','Groups','Events','Surveys','Hashtags'];
    var xyArray =  ['Year', 'Stream','Posts','Sub Groups','Events','Surveys','Search','Hashtags'];
