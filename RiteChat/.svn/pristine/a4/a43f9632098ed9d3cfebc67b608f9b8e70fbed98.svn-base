...
getTopicPosts('<?php echo $data->TopicId?>','<?php echo $data->TopicName?>')">
            <div class="topictitle paddingt5lr10 borderbottomtopic">
                <div class="media">
                    ...
                    <a class="pull-left marginzero smallprofileicon postdetail" data-id="53ece3a87f8b9a987c3a47e6" data-postid="53ece3667f8b9a8406966000" data-categorytype="2" data-posttype="5"><img src="<?php echo $data->ProfileImage; ?>"></a>
       ...
       <div class="artifactdiv borderbottomtopic paddingt5lr10">  
            ...
            <div class="paddingt5lr10">
                <div class="media">
                    ...
                    <a data-posttype="5" data-categorytype="2"  class="pull-left marginzero smallprofileicon postdetail">
                        <img src="<?php  echo $data->Post->OriginalUserProfilePic ?>"></a>
