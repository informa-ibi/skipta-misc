...
class SkiptaTopicService{
 ...
 public function UpdateCategoriesLowerCategoryName(){
     try{
        ...
        Yii::log("----in exception -----update categorieslowercategoryname-------------".$ex->getMessage(),'error','application');
     }
 ...
 public function deleteNetworkStreamInvite($streamId)
 {
     ...
     return $result;
        ...
        Yii::log("----in exception -----deleteNetworkStreamInvite-------------".$ex->getMessage(),'error','application');
     }
 }
