  <div class="padding10">
			<div class="headerpoptitle_white"><?php echo "Schedule a Game";?></div>
                 <?php
            ...
            <?php echo $form->hiddenField($scheduleForm, 'GameName',array('class'=>'')); ?>      
                ...
                <div class="groupcreationbuttonstyle">
                    <div class="row-fluid">
                        ...
                        <?php echo CHtml::resetButton('Cancel', array("id" => 'ScheduleGameReset', 'class' => 'btn btn_gray','onclick'=>'closeGameScheduleDiv("'. $scheduleForm->GameName.'","'. $scheduleForm->StreamId.'")')); ?>
                        </div>
                    </div>
