      ...
      ?>
        ...
        <div class="stream_content">
                     <div class="media" data-id="<?php echo $data[0]->_id ?>">
                           ...
                           <?php if($data[0]->Type==12){ echo $data[0]->GameDescription;}else{ echo $data[0]->Description;}?>
                            </div>
                        
                        
<div class="social_bar" data-groupid="<?php echo $data[0]->_id; ?>">   
   
              <span style="min-width: 40px" class="follow_a"><i><img data-placement="bottom" rel="tooltip"  data-original-title="<?php echo in_array(Yii::app()->session['TinyUserCollectionObj']['UserId'], $data[0]->Followers)?'Unfollow':'Follow' ?>" class="<?php echo in_array(Yii::app()->session['TinyUserCollectionObj']['UserId'], $data[0]->Followers)?'follow':'unfollow' ?>" src="/images/system/spacer.png"></i><b><?php echo count($data[0]->Followers) ?></b></span>
           <span><i><img data-placement="bottom" rel="tooltip"  data-original-title="Love" src="/images/system/spacer.png" class="<?php echo in_array(Yii::app()->session['TinyUserCollectionObj']['UserId'], $data[0]->Love)?'likes':'unlikes' ?>" ></i> <b><?php echo count($data[0]->Love) ?></b></span>
            <span><i><img data-placement="bottom" rel="tooltip"  data-original-title="Comment" src="/images/system/spacer.png" class="g_posts" ></i> <b><?php echo count($data[0]->Comments) ?></b></span>
