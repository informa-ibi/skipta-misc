...
<?php echo $form->error($advertisementForm, 'GroupId'); ?>
            ...
            <div class="row-fluid  padding-bottom10">
                ...
                <div class="span4" style="<?php echo $advertisements["SourceType"]=="StreamBundleAds"?'display:none':'display:block'?>">
...
<?php echo $form->error($advertisementForm, 'SourceType'); ?>
                ...
                <div class="row-fluid"  >
                   ...
                   <i id="StreamAdDimension1" style="display: none" class="fa fa-question helpmanagement helpicon top10  tooltiplink" style="font-weight: normal;z-index: 5" data-id="HintsforRandamNumbergenration_DivId" data-placement="bottom" rel="tooltip"  data-original-title="Hints for RandomNumber Generation" ></i>
                </div>          
                    </div>
                 ...
                 <div class="row-fluid customrowfluidad  " id="addServerAds2"  style="<?php echo $advertisements["SourceType"]=="AddServerAds"?'display:block':'display:none'?>" >
                    ...
                    <div class="control-group controlerror">
                        <?php echo $form->error($advertisementForm, 'ClickTag'); ?>
                              ...
                              <div class="row-fluid" id="bannerTemplateDiv1" style="<?php echo $advertisements["AdTypeId"]!="1"?'display:block':'display:none'?>" >
            ...
            <div class="row-fluid " id="uplloadAdPreview" style="<?php echo $advertisements["BannerOptions"]!="ImageWithText" && $advertisements["BannerOptions"]!="OnlyText"?'display:block':'display:none'?>"  >
                    <div class="span6 positionrelative">

                        <i class="fa fa-question helpmanagement helpicon top10  tooltiplink" style="display:block;font-weight: normal;z-index: 5" data-id="StreamAdDimension_DivId" data-placement="bottom" rel="tooltip"  data-original-title="Ad Dimentions" ></i>
                    ...
                    ?>
                        <div style="padding-bottom:10px; <?php echo ($advertisements["SourceType"]!="StreamBundleAds")?'display:block':'display:none'?>">
