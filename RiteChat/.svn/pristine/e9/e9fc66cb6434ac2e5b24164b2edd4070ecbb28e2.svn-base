...
//            }            
            $array = array(
             ...
             foreach($result as $data){
                 ...
                 if($textLength>240){
                    $data->SurveyDescription =  CommonUtility::truncateHtml($data->SurveyDescription, 240,'...',true,true,' <i class="fa fa-ellipsis-h moreicon"></i>');                     
                 }
