<div id="calculator"  class="rightwidgettitle paddingt12">
    ...
    <span class="widgettitle " id="calclick" style="cursor: pointer;">Calculator </span>
    <div class="calculator" id="collapseCal" >
            <form name="Calc">
                ...
                <div class="row-fluid ">
                <div class="span12 padding5">
                <input id="answerfield" name="Input" size="16"  class="span12 top_viewarea" type="text" placeholder="Answer" disabled="disabled"/>
                </div>
                </div>
                </div>
