...
<div style="position: relative">
        ...
        <div class="tablehead pull-left" >
                  ...
                  <span rel="tooltip" style="cursor: pointer;float:left;" onclick="createNewConfig()" role="button"  data-toggle="tooltip" title="Create New Parameter">
                        <i class="fa fa-plus-circle" style="vertical-align:top;"></i>
                            
                        </span>
                </div>
        <div class="tablehead pull-right" >
                <span rel="tooltip" class="pull-right" style="cursor: pointer;float:left;margin-right:8px;" onclick="refreshSettings()" role="button"  data-toggle="tooltip" title="Apply Settings">
             ...
             <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="odd">
                           ...
                           <td>
                                       {{if Enable == 0}}
                                              <a rel="tooltip" style="cursor: pointer;" data-id="{{>Id}}" class="editparameter" role="button"  data-toggle="tooltip" data-original-title="edit" > <i class="fa fa-pencil-square"></i></a> 
                                              {{/if}}
                                   </td>
                        </tr>
