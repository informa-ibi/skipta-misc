...
class TopLeadersCollection extends EMongoDocument {
   ...
   public function indexes() {
    ...
    public function saveTopLeadersData($reportDate,$TopUsers,$TopHashtags,$TopSearchitems,$TopNews) {
        try {
            $returnValue = 'failure';
            ...
            Yii::log($exc->getMessage() . "In save top leaders data collection", 'error', 'application');
        }
    }
     public function getTopLeadersData($reportDate) {
        try {
            $returnValue = 'failure';
            ...
            Yii::log($exc->getMessage() . "In get top leaders data collection", 'error', 'application');
        }
    }
