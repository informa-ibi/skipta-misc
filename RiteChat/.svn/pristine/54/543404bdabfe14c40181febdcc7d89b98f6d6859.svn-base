...
?>
<li class="woomarkLi unlogedProfile" >    
    <div class="post item" data-id="<?php  echo $data->_id ?>" data-postid="<?php  echo $data->PostId ?>" data-postType="<?php  echo $data->PostType;?>" data-categoryType="<?php  echo $data->CategoryType;?>" data-networkId="<?php  echo $data->NetworkId; ?>" data-scheduleId="<?php  echo $data->CurrentGameScheduleId; ?>" data-gameName="<?php  echo $data->GameName; ?>">  
        ...
        <div  style="cursor: pointer" class="stream_title paddingt5lr10" data-id="<?php  echo $data->_id ?>"> 
        ...
        <a  class="pull-left img_single" data-id="<?php  echo $data->_id ?>" data-postid="<?php echo $data->PostId;?>" data-categoryType="<?php echo $data->CategoryType;?>" data-postType="<?php echo $data->PostType;?>"><div class='<?php echo $videoclassName; ?>'><img src="/images/icons/video_icon.png"></div><img   src="<?php  echo $data->ArtifactIcon ?>"  ></a>
        <?php  }else{ ?>
            <a  class="pull-left img_more" data-id="<?php  echo $data->_id ?>" data-postid="<?php echo $data->PostId;?>" data-categoryType="<?php echo $data->CategoryType;?>" data-postType="<?php echo $data->PostType;?>"><div class='<?php echo $videoclassName; ?>'><img src="/images/icons/video_icon.png"></div><img src="<?php  echo $data->ArtifactIcon ?>"></a>
        <?php  }?>
            </div>
            <?php } ?>
            <?php } ?>
        <div class="stream_content">
            <div class="media" data-id="<?php echo $data->_id ?>">
                <div class="media-body  bulletsShow" data-id="<?php  echo $data->_id ?>">
...
<!--                            <div class="c_suffix"><input type="radio" class="styled" name="<?php  //echo "survey_".$data->PostId ?>" value="OptionFour"></div> -->
                ...
                <?php if($data->ActionType=='Comment' && isset($data->CommentMessage)){ ?>
                 <div class="padding4 ">
                     <?php if($data->CategoryType != 3 || ($data->CategoryType ==3 && $data->ConversationVisibility == 1)){ ?>
                <div class="commentbox padding4 " data-id="<?php  echo $data->_id ?>">
            ...
            <?php if(!isset($data->AddSocialActions) || $data->AddSocialActions==1) {?>     
                <div  class="social_bar" data-id="<?php  echo $data->_id ?>" data-postid="<?php  echo $data->PostId ?>" data-postType="<?php  echo $data->PostType;?>" data-categoryType="<?php  echo $data->CategoryType;?>" data-networkId="<?php  echo $data->NetworkId; ?>">	
                    ...
                    <?php if($data->CategoryType !=3 || ($data->CategoryType ==3 && $data->ConversationVisibility == 1)){ ?> <span><i><img  class=" tooltiplink <?php  echo $data->IsLoved?'likes':'unlikes' ?>"  data-placement="bottom" rel="tooltip"  data-original-title="Love" src="/images/system/spacer.png"></i><b id="streamLoveCount_<?php  echo $data->PostId; ?>"><?php  echo $data->LoveCount?></b></span> <?php  }?>
                        ...
                        <span class="sharesection" ><i class="tooltiplink" data-toggle="dropdown" rel="tooltip" data-original-title="Share" data-placement="bottom"><img src="/images/system/spacer.png"  class="share"  ></i><b id="streamShareCount_<?php  echo $data->_id; ?>"><?php  echo (isset($data->ShareCount) && is_int($data->ShareCount))?$data->ShareCount:0?></b>
                    ...
                    <span><i><img src="/images/system/spacer.png" class="tooltiplink <?php echo $data->IsCommented?'commented':'comments'?>" data-id="<?php  echo $data->_id ?>"  data-placement="bottom" rel="tooltip"  data-original-title="Comment"></i><b id="commentCount_<?php  echo $data->PostId; ?>"><?php  echo $data->CommentCount?></b></span>              
                    <?php  }?>
                </div> 
                     <?php } ?>
            </div>
