            ...
            <div id="profileDetailsDiv">
                <div id="area1" class="right">
                        <div class="btn-groupint" data-toggle="buttons-radio">
                            <button type="button" class="btnint profilei active">Profile</button>
                            <button type="button" class="btnint profilei ">Interactions</button>
                            <button type="button" class="btnint profilei">CV</button>
                        </div>
                </div>                
             ...
             <div class="row-fluid">
                <div class="span12">
                    <div class="span3 positionrelative">
                       <?php  if($IsUser == 1){?> <div><i data-original-title=" Profile Image  min size 250 X 250 px " rel="tooltip" data-placement="bottom" style="z-index:999;  " class="fa fa-question helpicon helpmanagement top10  tooltiplink" ></i> </div>  <?php  } ?>
...
<!--                                <img id="profileImagePreviewId" src="<?php  //echo $profileDetails->ProfilePicture ?>" alt="" />-->
                       ...
                       <div class="profileBar">
                           <ul class="profilesocial"><li> <span class="tooltiplink p_followers"  data-placement="bottom" rel="tooltip"  data-original-title="Followers" style='cursor: pointer' ><img src="/images/system/spacer.png"><i id='p_followersCount'><?php echo $profileDetails->UserFollowersCount ?></i ></span></li>
                            <li> <span class="tooltiplink p_following"  data-placement="bottom" rel="tooltip"  data-original-title="Following" style='cursor: pointer' ><img src="/images/system/spacer.png"/><i id='p_followingCount'><?php echo $profileDetails->UserFollowingCount ?></i></span></li></ul>
                    </div>
                    </div>
                <div class="span9">
...
<!--                        <div class="edit_iconbg edit_padding-top-3">-->
                            ...
                            <div  id="updateAndCancelFirstNameIconUploadButtons" class="edit_iconbar">
                                <i onClick="saveEditProfileFirstName('<?php  echo $profileDetails->UserId?>','FirstName');" class="fa fa-floppy-o editable_icons editable_icons_big" id=""></i>
                    ...
                    <div class="pull-left paddinglr ">
                                     ...
                                     <div id="editProfileLastName" style="display:none" class="positionrelative minheight21">
                                         ...
                                         <div  id="updateAndCancelLastNameIconUploadButtons" class="edit_iconbar">
                                             <i onClick="saveEditProfileLastName('<?php  echo $profileDetails->UserId ?>','LastName');" class="fa fa-floppy-o editable_icons editable_icons_big" id=""></i>
                    ...
                    ?>
                               <?php  if($IsUser == 1){?>
                                ...
                                <div class="alignright padding8top">
                                    ...
                                    ?>
                                    <?php  echo CHtml::resetButton('Close', array('type' => 'submit', 'id' => 'CancelEdit', 'class' => 'btn')); ?>
                                </div>
                            </div>
                               <?php  } ?>
