...
function CurbsidePostsend(){
    ...
    if(validateAtMentions(editorObject)){
        ...
        ajaxRequest('/curbsidePost/createCurbsidepost', data, function(data){sendCurbsidePostHandler(data,$('#CurbsidePostForm_IsFeatured').val())},"json",curbsidePostBeforesend);
            ...
            displayErrorMessage("CurbsidePostForm_Description","Description cannot be blank.");
        }
    }else{
...
function sendCurbsidePostHandler(data,isFeatureType){
    ...
    if (data.status == "success") {
        ...
        $("#sucmsgForStream").html("Your Curbside Consult has been posted successfully!");
...
function curbsideOnloadEvents(){
 ...
 function getCategoryPosts(categoryId){
    ...
    getCollectionData('/curbsidePost/getcurbsideposts', 'CategoryId='+g_curbside_categoryID+'&StreamPostDisplayBean', 'CategoryPostsDiv', 'No Posts found.', 'That\'s all folks!');
 ...
 function getHashtagsPosts(hashtagId){
   ...
   // $('.categorymemenuhelp').css('display', 'block');
    getCollectionData('/curbsidePost/getcurbsideposts','HashtagId='+g_curbside_hashtagID+'&StreamPostDisplayBean', 'CategoryPostsDiv', 'No Posts found.', 'That\'s all folks!');
    $("#curbsidePostsDiv").hide();
    $("#CategoryPostsDiv").show();
