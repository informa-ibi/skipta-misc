...
<div id="<?php echo str_replace(" ","",$Achievement); ?>_<?php echo $AchievementId; ?>" class="achievementschild">
    ...
    <div class="accordion-group">
        <div class="accordion-heading">
            ...
            <div class="sectionremove" data-placement="bottom" rel="tooltip"  data-original-title="Remove section" onclick="removeSection('<?php echo $AchievementId; ?>', '<?php echo str_replace(" ","",$Achievement); ?>', 'Am_dropdown', 'Achievements','')"><i class="fa fa-times"></i>
            </div>
        </div>
