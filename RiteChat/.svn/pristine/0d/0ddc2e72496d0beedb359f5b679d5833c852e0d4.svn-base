...
<!--                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>-->
                        ...
                        <div class="modal-footer" id="sessionTimeout_footer">
                            <button type="button" class="btn btn-small" id="login_btn" >Login</button>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer" id="myModal_footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal" id="myModal_closeButton">Close</button>
                            <button type="button" class="btn" id="myModal_saveButton">Save changes</button>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->
    ...
    <div class="padding10ltb">
        ...
        <div style="text-align: right" id="markallasreaddiv">
            <div class="markread" style="padding-bottom:4px;">
                   <a class="markallasread_notification markasreadlink" href="#" data-type="history"><i class="fa fa-check"></i> Mark all as Read </a>
                    </div>
        </div>
...
<div style="position:fixed;bottom:0;right:0;display: none;z-index: 9000;" id="minCharWidgetDiv" >
    ...
    <a href="#" class="chat_plus">Chat conversation Started... <i class="fa fa-plus"></i></a>
	</div>
    </div>
</body>
</html>
