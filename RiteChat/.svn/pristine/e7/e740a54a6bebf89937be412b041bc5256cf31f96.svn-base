            ...
            <div class="analytics_topleaders_box">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                     ...
                     <span class="">Group Activity <i class="cursor helpmanagement" data-id="GroupActivityHelpDescription_DivId" ><img src="/images/system/spacer.png" /></i></span>
                                ...
                                <li style="cursor:pointer; position: relative" class="dropdown pull-left">
                                    ...
                                    <div class="dropdown-menu analytics_export_div">
                                        ...
                                        <ul>
                                            ...
                                            <li class="" ><a href="#"  target="_blank" onclick="openGroupActivitypdf(this,'GroupActivity')" id="groupActivityPdf" name="groupActivityPdf"><i><img src="/images/system/spacer.png"  class="pdf_doc"></i> Export as PDF</a></li>
                                            <li class="" ><a href="#"  onclick="openActivityXls(this,'GroupActivity')" id="groupActivityXls"  target="_blank"><i><img src="/images/system/spacer.png" class="excel_doc"></i> Export as Excel</a></li>
                                        </ul>
                                    </div>
                                  </li>
                            </ul>
...
function getGroupActivityDetailsHandler(data1){ 
   ...
   //alert("handler");
    ...
    var xyArray =  ['Year', 'Posts','Event Posts','Survey Posts','Follows', 'Active Users', 'Come back Users'];
