...
<div  class="paddingtop6" id="gameAns_<?php echo $sno?>">
  ...
  <div class="span12">
  <div class="questiondiv positionrelative">
  <div class="disclaimertext"><span>Question Disclaimer</span> <?php echo $question['QuestionDisclaimer']?></div>
...
<div class="span6 "> <div class="answerdiv positionrelative"><div class="answertext">
 <div class="normalanswer positionrelative">
     <div class="answerradio">
         ...
         <input type="radio" name="question_<?php echo $sno?>" <?php if($answer=="A") echo 'checked '?> <?php echo $answer==""?'':"disabled='disabled'";?>   class="styled" value="A" />
...
></div>
 ...
 <div class="answerradio">
     ...
     <input type="radio" name="question_<?php echo $sno?>"  value="B" <?php if($answer=="B") echo 'checked' ?> <?php echo $answer==""?'':"disabled='disabled'";?>  class="styled"/>
              </span>
 </div>
...
<div class="span6 "> <div class="answerdiv positionrelative"><div class="answertext">
 ...
 <div class="answerradio">
     ...
     <input type="radio" name="question_<?php echo $sno?>"  value="C" <?php if($answer=="C") echo 'checked' ?> <?php echo $answer==""?'':"disabled='disabled'";?>    class="styled "/>
              </span>
 </div>
...
<div class="span6 "> <div class="answerdiv <?php if($question['OptionC']!="" ){ echo "answerdivright";}?> positionrelative"><div class="<?php if($question['OptionC']!="" ){ echo "answertextright";} else echo "answertext";?>">
 ...
 <div class="answerradio">
     ...
     <input type="radio" name="question_<?php echo $sno?>"  value="D" <?php if($answer=="D") echo 'checked' ?> <?php echo $answer==""?'':"disabled='disabled'";?>  class="styled "/>
              </span>
 </div>
...
<input type="submit" value="Finish" data-toggle="dropdown" name="submitGame" id="submitGame" class="btn btndisable"> 
</div>
</div>
