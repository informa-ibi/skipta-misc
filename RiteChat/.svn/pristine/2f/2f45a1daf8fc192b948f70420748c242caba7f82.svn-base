...
class DiseaseController extends Controller {
    ...
    public function actionGetUserGroupsLeftMenu() {
        try {
            ...
            error_log("gorups count" . count($userFollowingGroupsCount));
    ...
    public function actionGetcurbsideposts() {
        ...
        if (isset($_GET['StreamPostDisplayBean_page'])) {
            ...
            $conditionalArray = array(
                ...
                'CategoryType' => array('in' => array(2, 3)),
                'IsDeleted' => array('!=' => 1),
            ...
            if (isset($_GET['CategoryId'])) {
                error_log('categoryId************'.$_GET['CategoryId']);
            ...
            error_log("stream data" . $streamData);
