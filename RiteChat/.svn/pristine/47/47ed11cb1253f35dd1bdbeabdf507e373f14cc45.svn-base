         ...
         <div class="analytics_title positionabsolutetitle">Analytics</div>
                <div class="analytics_menu "> 
                     <ul id="tabs" class="" data-tabs="tabs">
                        ...
                        <li class="trafic"  onclick="getGroupTrafficDetails('<?php   echo $groupStatisticsData->_id ?>')"  data-placement="bottom" rel="tooltip"  data-original-title="Traffic" ><a href="#trafic" data-toggle="tab"><img src="/images/system/spacer.png" /></a></li>
                        <li class="usability" onclick="getGroupUsabilityDetails('<?php   echo $groupStatisticsData->_id ?>')"  ><a href="#usability" data-toggle="tab"   data-placement="bottom" rel="tooltip"  data-original-title="Usability"><img src="/images/system/spacer.png" /></a></li>
                        <li class="activity"  onclick="getGroupActivityDetails('<?php   echo $groupStatisticsData->_id ?>')"  data-placement="bottom" rel="tooltip"  data-original-title="Activity" ><a href="#activity" data-toggle="tab"><img src="/images/system/spacer.png" /></a></li>
...
<div class="analytics_title marginT10"><span class="">Leaders </span></div>
    <div class="row-fluid">
        <div class="sapn12">
            ...
            <span class="">Top 10 Users	 <i class="cursor helpmanagement"  data-id="GroupTop10Users_DivId"><img src="/images/system/spacer.png" data-original-title="Group Top 10 Users" rel="tooltip" data-placement="bottom" /></i></span>
            </div>
             <div class="r_followersdiv r_newfollowers padding10 borderzero">
                ...
                <li data-original-title="<?php echo $groupAnalytics['Topusers'][$i]['DisplayName']; ?>" rel="tooltip" data-placement="bottom" class="tooltiplink top_users ">
                    <a data-userid="2" class="miniprofileicon miniprofileDetails floatL">  
                        ...
                        <img src="<?php echo $groupAnalytics['Topusers'][$i]['ProfilePicture']; ?>">
                                            </a>
     ...
     <div class="row-fluid paddingtop12">        
        <div class="span6">
            <div class="analytics_topleaders_box" style="min-height:118px;">
                ...
                <i><img src="/images/system/spacer.png" /></i>
                <span class="">Top 10 Search Terms <i class="cursor helpmanagement" data-id="GroupTop10SearchTerms_DivId"><img src="/images/system/spacer.png" data-original-title="Group Top 10 Search Terms" rel="tooltip" data-placement="bottom" /></i></span>
                </div>
         ...
         <div class="span6">
            ...
            <i><img src="/images/system/spacer.png" /></i>
            <span class="">Top 10 Hash Tags <i data-id="GroupTop10HashTags_DivId" class="helpmanagement cursor"><img src="/images/system/spacer.png" data-original-title="Group Top 10 hashtags " rel="tooltip" data-placement="bottom" /></i></span>
            </div>
            <div class="padding10">
           <?php
