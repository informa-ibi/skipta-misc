...
<div class="normaloutersection normalouter_<?php echo $widgetCount; ?>">
     ...
     <div class="span6">
       <div class="control-group controlerror">
           <input type="text"  class="textfield span10 percentageOptionname" name="OptionName_<?php echo $widgetCount; ?>" data-hiddenname="ExtendedSurveyForm_OptionName_hid_<?php echo $i."_".$widgetCount; ?>" id="ExtendedSurveyForm_percentage_<?php echo $i."_".$widgetCount; ?>" onkeyup="insertText(this.id)" onblur="insertText(this.id)" maxlength="500">
