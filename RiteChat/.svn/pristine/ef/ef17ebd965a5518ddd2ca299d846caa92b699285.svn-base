                                ...
                                <div class="signdiv">
                                   ...
                                   <?php echo $form->hiddenField($helpIconCreation,'artifacts',array('value'=>'')); ?>
                                    <div class="headerbuttonpopup h_center padding8top">
                                        <?php echo CHtml::Button('Create',array('id' => 'newHelpIconId','class' => 'btn pull-right','onclick'=>'createHelp();')); ?> 
                                    </div>
                                    <?php echo CHtml::resetButton('Clear', array("id" => 'NewHelpIconReset', "style" => "display:none")); ?>
