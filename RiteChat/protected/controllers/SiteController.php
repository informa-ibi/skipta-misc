...
class SiteController extends Controller {
    ...
    public function actionLogin() {
        try {
           ...
           // echo "<pre>";print_r(Yii::app()->db->createCommand("select * from RiteChat.User where Email='".$model->email."'")->queryRow());exit;
            if ($resultArray == 'success') {
                ...
                $ret = ServiceFactory::getSkiptaPostServiceInstance()->saveUserLoginData($userObj->UserId);
                //print_r($ret);die();
