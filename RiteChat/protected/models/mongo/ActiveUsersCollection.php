...
class ActiveUsersCollection extends EMongoDocument {
   ...
   public function indexes() {
    ...
    public function saveActiveUsersData($reportDate,$users) {
        try {
...
//	}
      ...
      public function saveGroupWiseActiveUsersAnalyticsData($reportDate,$users,$groupId) {
        ...
        public function CheckActiveUsersDataExistByDate($reportDate) {
        try {
            $returnValue = 'failure';
    ...
    public function updateActiveUsersDataExistByDate($reportDate,$users){
         $returnValue='failure';
        try {
