         ...
         //   $streamObj->Title= $obj->Title;
              ...
              if ($obj->CategoryType == 9) {
               ...
               // $streamObj->PostFollowers = $obj->PostFollowers;
                ...
                // error_log("-UserActivtiy collection-------------".$obj->CurrentGameScheduleId);
            ...
            //echo '______________in save user activitity  __________' . $exc->getMessage();
             echo $exc->getLine().'___________sssssss___in save user activitity  __________' . $exc->getTraceAsString();
        }
    }
    /**
    ...
    */
    ...
    public function getActvityObjbyPostId($postId, $userId,$categoryType) {
        try {
            ...
            echo "* Excepiton at get activity obj by post id" . $ex->getTraceAsString();
        }
    }
     /**
   * @author vamsi krishna 
   ...
   */  
    public function updateUserActivityForUserFollow($id,$recentActivity, $createdDate='') {
     ...
     public function updateActvitySocialActions($obj) {
        try {
            ...
            echo "exception occur while update stream of social actions User Activity updateActvitySocialActions()" . $exc->getMessage();
        }
     ...
     public function followObject($obj) {
        try {
          ...
          //  $mongoModifier->addModifier('CreatedOn', 'set', new MongoDate(strtotime(date('Y-m-d H:i:s', time())))); 
            ...
            echo "exception occur while update stream of social actions User Activity followObject()" . $exc->getMessage();
        }
     ...
     public function unFollowObject($obj) {
        try {
          ...
          //  $mongoModifier->addModifier('CreatedOn', 'set', new MongoDate(strtotime(date('Y-m-d H:i:s', time())))); 
            ...
            echo "exception occur while update stream of social actions User Activity unFollowObject()" . $exc->getMessage();
        }
        ...
        try {
          ...
          if($actionType=="EventAttend"){
            ...
            if($actionType=="Comment"){
             ...
             //error_log($streamObjectId."*****************************************".$obj->PostId);
    ...
    public function getEngageObjbyPostId($postId, $userId,$categoryType) {
        try {
            ...
            echo "* Excepiton at get Engage obj by post id" . $ex->getTraceAsString();
        }
    }
     ...
     public function updatePostManagementActions($obj) {
        try {
           ...
           if ($obj->ActionType == 'Abuse') {
            ...
            echo "exception occur while user activity collection post management actions updatePostManagementActions()" . $exc->getMessage();
        }
    }
    /**
     * @author sagar
     ...
     */
       ...
       public function updateCommentManagementActions($obj) {
        try {echo "$obj->PostId********$obj->ActionType***$obj->CommentId******$obj->CatagoryId**";
            $mongoCriteria = new EMongoCriteria;
            $mongoModifier = new EMongoModifier;
            $mongoCriteria->addCond('PostId', '==', new MongoID($obj->PostId));
           ...
           if ($obj->ActionType == "CommentBlock") {
            ...
            echo "exception occur while user activity collection comment management actions updateCommentManagementActions()" . $exc->getMessage();
        }
    }
