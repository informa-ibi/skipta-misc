            ...
            if (isset($post->Resource)) {
                ...
                foreach ($resources as $resource) {
                    if (!isset($resource['Height'])) {
                       ...
                       // error_log("ResourceName-------" . $resource['ResourceName'] . "--" . $resource['Height']);
                    }
                }
                ...
                foreach ($comments as $comment) {
                    ...
                    foreach ($artifacts as $artifact) {
                        if (!isset($artifact['Height'])) {
                           ...
                           // error_log("ResourceName-------" . $artifact['ResourceName'] . "--" . $artifact['Height']);
                        }
                    }
...
//              }  
               ...
               // error_log("elseeeeeeeeee-----" . $resource['ThumbNailImage']);
            }
        }
    }
