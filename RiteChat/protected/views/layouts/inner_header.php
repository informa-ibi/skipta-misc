                    ...
                    <div class="span5">
                        <div class="navigation" id="headernavigation_normal">
                            <ul>
                                ...
                                <li ><a href="/groups" id="groupmainmenu" class="submenu" ><span <?php if ($this->whichmenuactive == 3) { ?>class="active"<?php } ?>>Toolbox</span></a>
                                    ...
                                    <li><a id="" class="submenu cursorp" ><span <?php if ($this->whichmenuactive == 8) { ?>class="active"<?php } ?>>Admin</span></a>
                                        <div class="dropdown-menu dropdownmenudiv">
                                            <ul class="sub" >                        
                                                ...
                                                <li><a href="/managetoolbox">Toolbox Management</a></li>
