...
<!--<div class="row-fluid " id="postDetailedTitle">
    ...
    <div class="stream_widget marginT10" id="postDetailedwidget">
   	 <div class="profile_icon"><img src="<?php  echo $tinyObject->profile250x250;?>" > </div>
                            ...
                            <?php    
                                ...
                                <script type="text/javascript">
                                  ...
                                  var height = 250;
                                      ...
                                      drawSurveyChart('<?php   echo "surveyGraphArea_$data->_id"; ?>', <?php   echo $data->OptionOneCount ?>, <?php   echo $data->OptionTwoCount ?>,<?php   echo $data->OptionThreeCount ?>,<?php   echo $data->OptionFourCount ?>,height,width);
                                  });
                                </script>
                            <?php   } } ?>
               ...
               <?php }?>
                ...
                <?php if($categoryType<3){
                    ...
                    if(!$IsTwitterShare || !$IsFbShare){
                        ...
                        ?>
                <span class="sharesection" id="sharesec"><i class="tooltiplink" data-toggle="dropdown" rel="tooltip" data-original-title="Share" data-placement="bottom"><img src="/images/system/spacer.png"  class="<?php echo $shareClass; ?>"  ></i><b id="streamShareCount_<?php  echo $data->_id; ?>"><?php  echo $ShareCount;?></b>
                <?php }else{?>
...
$(function(){
    Custom.init();
    $("#detailedLove,#detailedfolloworunfollow,#invitefriendsDetailed,#detailedComment,#sharesec").on("click",function(){
        showLoginPopup();
    });
});
