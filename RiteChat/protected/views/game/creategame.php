...
<div  class="groupbanner positionrelative editicondiv" >    
    ...
    <div class="edit_iconbg tooltiplink cursor" data-original-title="Upload  1044 x 200 dimensions" rel="tooltip" data-placement="bottom">
...
<img style="max-width:100%" src="<?php if(isset($gameDetails) && count($gameDetails)>0){echo $gameDetails['GameBannerImage'];}else{ echo "/images/system/game_banner.jpg"; } ?>"  id="GameBannerPreview"/>
    ...
    <div id="groupProfileDiv" class="row-fluid padding8top" >
     ...
     <div class="padding8top">
          ...
          <div class="grouplogo positionrelative editicondiv">
             ...
             <div id="editGroupName" class="control-group controlerror">
                  ...
                  <div class="editable" style="padding: 0px;">
                      ...
                      <div id="GameName"   class="e_descriptiontext gameplaceholder " placeholder="GameName"  <?php if(isset($gameDetails) && count($gameDetails)>0){ ?> onclick="ShowGameEditButtonArea('GameName','<?php echo $gameId; ?>')"  <?php }  ?> contentEditable="true" ><?php if(isset($gameDetails) && count($gameDetails)>0){echo $gameDetails['GameName'];} ?></div>
          ...
          <div class="" id="profile">
              ...
              <div id="groupDescriptionTotal" style="display:none;padding: 5px"     class="groupabout"><div class="e_descriptiontext" id="descriptioToshow">gamedescription</div>
 ...
 <div class="row-fluid groupseperator">
     <div class="span12 paddingtop10 border-bottom">
         <div class="span6"><h2 class="pagetitle"><?php if(isset($gameDetails) && count($gameDetails)>0){ echo "Edit Game Questions";}else{echo "New Game Questions";} ?> </h2></div>
        <div class="span6" style="padding:5px 10px 0 0;" ><button type="button" style=" <?php if(isset($gameDetails) && count($gameDetails)>0){ echo 'display:none';}else{echo 'dosplay:block';} ?> " data-original-title="Add Onemore Question" rel="tooltip" data-placement="bottom" class="newQuestionsbutton pull-right"  onclick="addOneMoreQuestion()"></button></div>
         </div>
...
<div class="panel panel-default section1">
    <button   data-original-title="Delete" rel="tooltip" data-placement="bottom" class="close plus minus pull-right gameactionsright" data-dismiss="alert"   onclick="closeNewQuestion('0')" type="button"> <i class="fadelete" >X</i> </button>
...
<div class="span12">
    <div class="span8">
         <label id="label_0"  name="QuestionLabel" >Question </label>
    </div>
    <div class="span4">
        ...
        <div class="positionrelative ">
            ...
            <div class="marginleft110 marginleft50">
                ...
                <div class="control-group controlerror " id="GameQuestion_optionA_0">
                    ...
                    <div id="GameQuestion_optionA_0_error" name="Choice-1"  class="errorMessage marginbottom10 error" style="display:none"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="positionrelative ">
            ...
            <div class="marginleft110 marginleft50">
                ...
                <div class="control-group controlerror " id="GameQuestion_optionB_0">
                    ...
                    <div id="GameQuestion_optionB_0_error" name="Choice-2" class="errorMessage marginbottom10 error"  style="display:none"></div>
                </div>
            </div>
        </div>
    </div>
...
<!--                                                <input type="button" class="btn btn-success  btn-large btn-block r_login" onclick="clicksub()"/>-->
                    ...
                    <?php echo CHtml::resetButton('Cancel', array("id" => 'gameResetId','onclick' => 'CancelGameCreation();',  'class'=>'btn btn_gray'));  ?>
...
{    
    ...
    var name= $('#'+obj.id).siblings('div').attr('name');
         $('#'+obj.id).siblings('div').html("please enter "+name);
...
//            forcePlaceholderSize: true,
    ...
    var g_groupPicture = '';
     ...
     var Questionextensions='"jpg","jpeg","gif","mov","mp4","mp3","avi","png","tiff","mov","flv"';
  initializeFileUploader('GameBannerImage', '/game/UploadGameBannerImage', '10*1024*1024', extensions, 1,'GameBannerImage' ,'',GameBannerPreviewImage,displayErrorForBannerAndQuestion,"uploadlist");
  initializeFileUploader('GameQuestionImage_0', '/game/UploadGameBannerImage', '10*1024*1024', Questionextensions,1, 'GameQuestionImage_0' ,'0',GameQuestionPreviewImage,displayErrorForBannerAndQuestion,"uploadlist_0");
        ...
        if($.trim($('#GameName').text()).length>0){
           ...
           $('#GameName_error').html("");
            ...
            return false;
              ...
              $('#GameName_error').html("please enter GameName ");
              $('#GameName_error').show();
    ...
    { 
         ...
         if($.trim($('#GameDescription').text()).length>0){
            ...
            return false;
              ...
              $('#GameDescription_error').html("please enter GameDescription ");
               ...
               // var div="<div class='alert-model fade in' id='error_remove_div' style='position: relative'><button  class='close' data-dismiss='alert' type='button'>x</button>";
                ...
                var OptionsArray=new Array();
                    ...
                    {k++;
                        ...
                        $('#'+id+'_error').html("please Enter Question ");
                        $('#'+id+'_error').show();
                    ...
                    {k++;
                        ...
                        $('#'+id+'_error').html("please enter Choice 1 ");
                        $('#'+id+'_error').show();
                        $('#'+id+'_error').fadeOut(7000);
                    ...
                    {k++;
                        ...
                        $('#'+id+'_error').html("please enter Choice 2 ");
                        $('#'+id+'_error').show();
                        $('#'+id+'_error').fadeOut(7000);
                  ...
                  if(check==false){
                      ...
                      $('#UniqueOption_'+SelectedQuestionId).html("please select the Unique Choice.");
                    ...
                    {k++;
                       ...
                       // $("#error_remove_div").append("<li>Please Enter Choice-4 of Question :" + (i+1)+"</li>");
                        ...
                        $('#'+id+'_error').html("please enter Points ");
                        $('#'+id+'_error').show();
                        $('#'+id+'_error').fadeOut(7000);
                    }
                    ...
                    if(Answer.length==0){
                        ...
                        $('#CorrectAnswer_'+SelectedQuestionId).html("please select the Correct Answer.");
...
//                         Q++;
//                      
//                        $('#GameQuestion_'+Question_description[i]).html("please enter Question Disclaimer.");
...
//                         Q++;
//                    
//                        $('#GameQuestion_editable_'+SelectedQuestionId).html("please enter Question Disclaimer.");
...
//                    }
                   ...
                   k++;
                   g_question.length
                   $('#errormsgForGame').html("please select one Question.");
                ...
                $( ".questionClass" ).each(function(key,index) {
                    ...
                    for(var i=0;i<g_question.length;i++){
                        ...
                        question.answer=CorrectAnswer[i];
                        question.position=i;
  ...
  function saveGameFormHandler(data){
            ...
            if(data.status=="success"){
                ...
                //$("#reg_error").removeClass();
                 $('#sucmsgForGame').show();
                 if(data.message!=""){
                      $("#sucmsgForGame").html("Game updated successfully");
                       window.location='/game/index';
                     
                 }else{
                   
                     $("#sucmsgForGame").html("Game created successfully");
                    window.location='/game/index';
                 }
