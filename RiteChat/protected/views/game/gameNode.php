<script type="text/javascript">
    ...
    if (typeof io !== "undefined") {
        ...
        socket4Game.on("connect", function() {
            ...
            gameSocialStatsInterval = setInterval(function() {// calling for every 10 seconds
                ajaxRequest("/user/checkSession", "", sessionAliveHandlerTen);
            ...
            function sessionAliveHandlerTen(data) {
                if (data.code != 440) {
//                socket4Game.emit('clientRequest4Game', g_postIds);
                } else {
