...
<div class="panel panel-default section1">
     <button  data-original-title="Delete" rel="tooltip" data-placement="bottom" class="close plus minus pull-right gameactionsright"  onclick="closeNewQuestion('<?php echo ($QuestionId); ?>')" data-dismiss="alert" type="button"> <i class="fadelete">X</i> </button>
