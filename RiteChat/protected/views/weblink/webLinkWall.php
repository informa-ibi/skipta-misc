                                ...
                                <div id="snippet_main" style="clear:both;">
                                    <div class="Snippet_div" >
                                        ...
                                        <div class="media-body">                                   
                                            ...
                                            <a class="websniplink" href="<?php echo $webLink['WebUrl']; ?>" target="_blank"> <label style="cursor: pointer" class="websnipheading"><?php echo $webLink['WebTitle'] ?></label></a>
