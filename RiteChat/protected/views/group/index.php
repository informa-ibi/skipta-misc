...
<div class="row-fluid" >
    <div class="span3" id="numero1"><h2 class="pagetitle">Toolboxes </h2></div><!-- This id numero1 is used for Joyride help -->
    ...
    <div class="span9 ">
        <!--replace class "fa fa-question" with  "fa fa-video-camera videohelpicon" if we have description and video remaining will be same-->
            ...
            <input class="btn " id='addGroup' name="commit" type="submit" data-toggle="dropdown" value="Add New Toolbox" /> 
             
<div id="addNewGroup" class="dropdown dropdown-menu actionmorediv actionmoredivtop newgrouppopup newgrouppopupdivtop" >
            
			<div class="headerpoptitle_white"><?php echo Yii::t('translation', 'Toolbox_Creation');?></div>
                <?php
                ...
                <div class="row-fluid  ">
                    <div class="span12">
                       ...
                       <?php echo $form->labelEx($newGroupModel, Yii::t('translation', 'ToolboxName')); ?>
                ...
                <div class="row-fluid  ">
                    ...
                    <?php echo $form->labelEx($newGroupModel, Yii::t('translation', 'ToolboxDescription')); ?>
                ...
                <div class="row-fluid padding8top">
                    <div class="span12">
                        <div class="span6">
                            <?php echo $form->labelEx($newGroupModel, Yii::t('translation', 'ToolboxMode')); ?>
              ...
              array('0' => ' Native Mode'),array('empty' => "Select mode type",'class'=>"styled span12 textfield")); ?>
                        ...
                        <div class="span6" style="display: none;" id="custommenu">
                            <?php echo $form->labelEx($newGroupModel, Yii::t('translation', 'ToolboxMenu')); ?>
            ...
            <?php $this->endWidget(); ?>
             ...
             <?php }?>
            <i data-id="Groups_DivId" class="fa fa-question helpicon helpmanagement helprelative pull-right pull-bottom tooltiplink" data-placement="bottom" rel="tooltip"  data-original-title="Toolboxes" ></i> 
        </div>
...
<div id="groupslogoarea" class="groupslogoarea">
    ...
    <div id="numero2"><h2 class="pagetitle">Join More Toolboxes </h2></div><!-- This id numero2 is used for Joyride help -->
...
Custom.init();
     $(document).ready(function(){   checkPrivateAndAutoFollow();   
        ...
        getCollectionData('/group/getJoinMoreGroups', 'GroupCollection', 'MoreGroupsDiv', 'No toolboxes found','No more toolboxes');
