               ...
               <div class="analytics_widgetheader">
                <div class="row-fluid">
                    ...
                    <div class="span12">
                     ...
                     <span >Usability-<b>Browsers</b> <i class="cursor helpmanagement" data-id="GroupUsabilityHelpDescription_DivId"><img src="/images/system/spacer.png"  /></i></span>
                    
                </div>
                         <div class="switch_mode pull-left ">
                           
                	 <ul style="white-space: nowrap;">
                                <li class="active" id="groupBrowserLineChart"> <a  class="linechart"><img class=" tooltiplink cursor" rel="tooltip"  data-original-title="Line chart" src="/images/system/spacer.png" /></a></li>
                                <li  id="groupBrowserPieChart" ><a  class="piechart"><img class=" tooltiplink cursor" rel="tooltip"  data-original-title="Pie chart" src="/images/system/spacer.png" /></a></li>
                            </ul>
                </div> </div>
                                ...
                                <li style="cursor:pointer; position: relative" class="dropdown pull-left">
                                    ...
                                    <div class="dropdown-menu analytics_export_div">
                                        ...
                                        <ul>
                                            ...
                                            <li class="" ><a onclick="openGroupUsabilityActivitypdf(this,'GroupBrowserUsability')" id="groupBrowserActivityPdf" name="browserActivityPdf"><i><img src="/images/system/spacer.png"  class="pdf_doc"></i> Export as PDF</a></li>
                                            <li class="" ><a href="/analytics/GenerateXLS?startdate=1234&enddate=456"  onclick="openGroupUsabilityActivityXls(this,'GroupBrowserUsability')" id="groupBrowserActivityXls"  target="_blank"><i><img src="/images/system/spacer.png" class="excel_doc" onclick="openActivityXls()"></i> Export as Excel</a></li>
                                        </ul>
