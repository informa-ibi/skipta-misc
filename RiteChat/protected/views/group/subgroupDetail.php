 ...
 <div class="row-fluid" id="groupProfileDiv">
     ...
     <div class="padding8top">
        ...
        <i class="fa fa-times-circle editable_icons editable_icons_big darkgreycolor" onclick="cancelBannerOrIconUpload('<?php   echo $groupStatistics->SubGroupIcon?>','GroupProfileImage')"></i>
         ...
         <!--<div  class="grouplogoheading padding8top" ><?php   echo $groupStatistics->SubGroupName?><span id="followGroupInDetail" class="social_bar noborder profile_bar" data-subgroupid="<?php   echo $groupStatistics->SubGroupId ?>" data-groupid="<?php   echo $groupStatistics->GroupId ?>" data-category="SubGroup" > <a><i  ><img class=" tooltiplink cursor <?php   echo in_array(Yii::app()->session['TinyUserCollectionObj']['UserId'], $groupStatistics->SubGroupMembers)?'followbig':'unfollowbig' ?>"  src="/images/system/spacer.png" data-placement="bottom" rel="tooltip"  data-original-title="<?php   echo in_array(Yii::app()->session['TinyUserCollectionObj']['UserId'], $groupStatistics->SubGroupMembers)?'Unfollow':'Follow' ?>"></i></a> </span></div>-->
     ...
     <?php   if(strlen($groupStatistics->SubGroupDescription)>240){?>
         <div class="alignright clearboth" id="g_descriptionMore"> <a  class="more">more <i class="fa fa-chevron-circle-right"></i></a></div>
     <?php   }?>
...
<div  class="poststreamwidget" id="groupFormDiv" style="display:none">
 ...
 <div class="row-fluid  customrow-fluid" >
    ...
    <div id="editable"  placeholder="New Post" class="placeholder inputor"  data-type="group" contentEditable="true" <?php if($groupStatistics->DisableWebPreview==0){?> onkeyup="getsnipetForGroup(event,this);" <?php }?> onblur="validateDescription(this)"></div>
    <div class="control-group controlerror">  
...
<?php  }?>
   ...
   <?php   echo $form->error($groupPostModel, 'Artifacts'); ?>
    ...
    <div class="pull-right">
         <?php   echo CHtml::Button('Post',array('class' => 'btn','onclick'=>'groupsend('.$groupStatistics->IsGroupPrivate.');')); ?> 
