            ...
            <div class="analytics_topleaders_box">
                ...
                <div class="row-fluid">
                    <div class="span12">
                     ...
                     <span class="">Group Traffic <i class="cursor helpmanagement" data-id="GroupTrafficHelpDescription_DivId"><img src="/images/system/spacer.png" /></i></span>
                                ...
                                <li style="cursor:pointer; position: relative" class="dropdown pull-left">
                                    ...
                                    <div class="dropdown-menu analytics_export_div">
                                        ...
                                        <ul>
                                            ...
                                            <li class="" ><a  href="/analytics/Pdf?date=1234" target="_blank" onclick="openActivitypdf(this,'GroupTraffic')" id="GroupTrafficPdf" name="GroupTrafficPdf"><i><img src="/images/system/spacer.png"  class="pdf_doc"></i> Export as PDF</a></li>
                                            <li class="" ><a href="/analytics/GenerateXLS?startdate=1234&enddate=456"  onclick="openActivityXls(this,'GroupTraffic')" id="GroupTrafficXls"  target="_blank"s><i><img src="/images/system/spacer.png" class="excel_doc"></i> Export as Excel</a></li>
                                        </ul>
