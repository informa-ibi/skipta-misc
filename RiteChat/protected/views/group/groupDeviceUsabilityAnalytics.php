               ...
               <div class="analytics_widgetheader">
                <div class="row-fluid">
                    ...
                    <div class="span12">
                     ...
                     <span >Usability-<b>Devices</b> <i class="cursor helpmanagement" data-id="GroupUsabilityHelpDescription_DivId"><img src="/images/system/spacer.png" /></i></span>
                	...
                	<ul>
                        ...
                        <li  id="groupDevicePieChart" ><a  class="piechart"><img class=" tooltiplink cursor" rel="tooltip"  data-original-title="Pie chart" src="/images/system/spacer.png" /></a></li>
                        </ul>
                </div> </div>
                                ...
                                <li style="cursor:pointer; position: relative" class="dropdown pull-left">
                                    ...
                                    <div class="dropdown-menu analytics_export_div">
                                        ...
                                        <ul>
                                            ...
                                            <li class="" ><a onclick="openGroupUsabilityActivitypdf(this,'GroupDeviceUsability')" id="groupDeviceActivityPdf" name="groupDeviceActivityPdf"><i><img src="/images/system/spacer.png"  class="pdf_doc"></i> Export as PDF</a></li>
                                            <li class="" ><a href="/analytics/GenerateXLS?startdate=1234&enddate=456"  onclick="openGroupUsabilityActivityXls(this,'GroupDeviceUsability')" id="groupDeviceActivityXls"  target="_blank"><i><img src="/images/system/spacer.png" class="excel_doc"></i> Export as Excel</a></li>
                                        </ul>
