            ...
            <div class="span12 positionrelative">
                ...
                <div class="analytics_menu "> 
                    <ul id="tabs" class="" data-tabs="tabs">
                        ...
                        <li class="usability" onclick="getUsabilityDetails('default')"  ><a href="#usability" data-toggle="tab"   data-placement="bottom" rel="tooltip"  data-original-title="Usability"><img src="/images/system/spacer.png" /></a></li>
...
//        }
    ...
    if (detectDevices()) {
        ...
        $("#chart_div,#devicechart_div,#browserchart_div,#locationchart_div").attr("style", "width: 900px; height: 550px;");
        $("#engagement_chart_div").attr("style", "width: 1048px; height: 550px;");
        $("#Traffic_chart_div").attr("style", "min-width:100%; height: 550px;");
    }
    
    function setNewDateForTraffic(){
            var dateEnd = new Date();
            var dateEndYear = dateEnd.getFullYear();
            var dateEndMonth = dateEnd.getMonth();
            dateEndMonth++;
            var dateEndDate = dateEnd.getDate();
            var dateStart =  dateEnd.setMonth(dateEnd.getMonth() - 6);
            dateStart = new Date(dateStart);
            var dateStartYear = dateStart.getFullYear();
            var dateStartMonth = dateStart.getMonth();
            dateStartMonth++;
            var dateStartDate = dateStart.getDate();
            var mainEndDate = formatDates(dateEndYear, dateEndMonth, dateEndDate, Global_date_Format);
            var mainStartDate = formatDates(dateStartYear, dateStartMonth, dateStartDate, Global_date_Format);
            
            $('#Traffic_StartDate' ).val(mainStartDate);

            $('#Traffic_EndDate').val(mainEndDate);
    }
