...
foreach($job as $rw){
    if($rw['Source'] != 'hec'){ 
    ?>        
<table border="0" cellpadding="0" cellspacing="0"style="width:600px;margin:auto">
<tr>
    <td>
	...
	<tr>
        ...
        <tr>
            <td style="padding:10px;text-align: right">                
                ...
                <input data-uri="<?php echo $rw['InternalApplyUrl']; ?>" type="button" value="Apply Now" name="commit" class="btn btn-mini jobsapplybutton"  />
            </td>            
        </tr>
        <?php } ?>
        </table>
