...
foreach ($data as $key => $value) {
    ...
    <div class="commentsection" id="comment_<?php  echo $value->PostId ?>_<?php  echo $value->CommentId ?>">
          ...
          if(count($value->Resource)!=0){
             ...
             <?php } ?>
   <a  class="<?php echo $class;?>"  data-profile="<?php echo $profile; ?>"  data-id='<?php  echo $streamId; ?>' data-posttype="<?php echo $value->Type;?>"   data-categorytype="<?php echo $value->CateogryType;?>"   data-postid="<?php echo $value->PostId;?>"  >
...
//                    }
                      ...
                      <?php  }else if($extType == "mp4" || $extType == 'flv' || $extType == 'mov'){
                        ...
                        <?php  }else  if($extType == "jpg" || $extType == "png" || $extType == "jpeg" || $extType == "giff"){?>
                            <div class="span3">    
                               <div class="d_img_outer" id="comment_artifactOpen">
                                    <?php if($value->CateogryType=='3'){ ?>
          ...
          <?php }?>         
                <div class="media-body overfolw-inherit" >
                    <div class="positionrelative padding-right30 streampostactions">
                        ...
                        <?php } ?>
                        <div id="comment_text" data-id="<?php  echo $value->PostId; ?>"><?php echo $value->CommentText; ?></div>
