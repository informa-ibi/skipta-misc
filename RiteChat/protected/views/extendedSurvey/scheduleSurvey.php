...
<div class="padding10">    
 ...
 <div class="span6 radiobutton" id="renewscheduledivid">
    ...
    <div class="row-fluid">
        <div class="span4" id="surveylogodivid">
            <div id="SurveyLogo" class="uploadicon"></div>
            <img id="SurveyLogoimg" src="/images/system/spacer.png">
        </div>                
         <ul class="qq-upload-list" id="uploadlistSchedule"></ul>       
        <div class="span4" id="instreamadlogodivid" style="display: none;">
