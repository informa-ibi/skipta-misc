...
<div class="row-fluid" >
    <div class="span12" style="margin: auto">
        <div class="pull-righ">
            ...
            <?php echo CHtml::resetButton('Clear', array("id" => 'forgotReset2', "style" => "display:block", 'class' => 'btn btn-2 btn-2a btn_gray pull-right margin-right10')); ?>
        </div>
    </div>
</div>
<?php $this->endWidget(); ?>  
