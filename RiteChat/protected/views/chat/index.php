...
?>
    ...
    <div class="span9">
         <div class="row-fluid ">
    <div class="span12 "><h2 class="pagetitle">Messaging</h2></div>
    ...
    <div class="span6">
     ...
     <div class="pull-right"><input type="text" placeholder="Invite..." size="40" name="q" id="inviteInput"></div>
    </div>
    </div>
    </div>
           ...
           <div class="chatplacediv">
               <ul>
                   <li  class="active" id="liInbox">
                       <a href="#" id="inboxUsers">Inbox <span style="" class="not_count " id="inboxCount"></span></a>
                   </li>
                   <li id="liFindUser">
                       <a href="#" id="findUsers">Find Users</a>
                   </li>
               </ul>
           </div>
<div class="searchdivbox">
    <div class="search marginzero">
    <input type="text" class="marginzero span12" placeholder="Search..." size="40" name="q" id="chatFriendsSearch" value="Search..." >
<input type="text" class="marginzero span12" placeholder="Search..." size="40" name="q" id="findFriendsSearch" value="Search..." style="display: none">
</div> 
    </div>
...
?>
 ...
 <script type="text/javascript">   
     $("#menu li a").removeClass( "tr_active" );
     $("#Private_Messaging").addClass( "tr_active" );
