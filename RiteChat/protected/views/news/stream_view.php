...
<div class="customwidget_outer">
    <div class="customwidget <?php echo $data->Alignment?>" style="padding-bottom:10px">
...
<div class="row-fluid">
<div class="span12">
<div  class="decorated span12 EDCRO<?php echo $data->PostId?>">
<?php
           $editorial=$data->Editorial;
           if(strlen($data->Editorial)>240)
           {
             $editorial=substr($editorial, 0,240);
             $editorial=$editorial.'<a data-placement="bottom" rel="tooltip"  data-original-title="show more" class="showmore" data-id="'.$data->PostId.'">...</a>';
             echo $editorial;
           }
           else
           {
