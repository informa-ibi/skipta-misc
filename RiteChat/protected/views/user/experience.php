...
<div class="accordion-group">
    <div class="accordion-heading">
        ...
        <div class="sectionremove" data-placement="bottom" rel="tooltip"  data-original-title="Remove section" onclick="removeSection('<?php echo $ExperienceId; ?>','<?php echo str_replace(" ","",$Experience); ?>','EX_dropdown','Experience','')"><i class="fa fa-times"></i>
        </div>
    </div>
