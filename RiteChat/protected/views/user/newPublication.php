    ...
    <div class="span12">
        <div class="span4">
            ...
            <div class="control-group controlerror marginbottom10">
                <input type="text" name="UserCVForm[PublicationName][<?php echo $PublicationId; ?>]" class="tooltiplink span12 textfield" maxlength="30" id="UserCVForm_Name_<?php echo $PublicationId; ?>">   
        ...
        <div class="span4">
            ...
            <div id="publication_Date_<?php echo $PublicationId; ?>" class="input-append date" data-date-format="<?php echo Yii::app()->params['DateFormat']; ?>" data-date="">
                  ...
                  <input type="text" name="UserCVForm[PublicationDate][<?php echo $PublicationId; ?>]" class="tooltiplink span12 textfield" maxlength="30" id="UserCVForm_Date_<?php echo $PublicationId; ?>">   
        ...
        <div class="span4">
            ...
            <div class="control-group controlerror marginbottom10">
                <input type="text" name="UserCVForm[PublicationTitle][<?php echo $PublicationId; ?>]" class="tooltiplink span12 textfield" maxlength="30" id="UserCVForm_Title_<?php echo $PublicationId; ?>">   
...
<div class="row-fluid padding8top">
    <div class="span12">
            <div class="padding-bottom5">
                <span class="authortext"><?php echo Yii::t('translation', 'User_Publication_Authors'); ?> <i data-original-title=" Type a word then press enter key" rel="tooltip" data-placement="bottom" data-id="id" style="font-weight: normal;top:81px;right:auto;float:left;margin-left:12px;" class="fa fa-question helpmanagement helpicon top10  tooltiplink"></i> </span>
...
<div class="row-fluid padding8top">
    <div class="span12">
        <div class="span4">
            ...
            <div class="control-group controlerror marginbottom10">
                <input type="text" name="UserCVForm[PublicationLocation][<?php echo $PublicationId; ?>]" class="tooltiplink span12 textfield" maxlength="50" id="UserCVForm_Location_<?php echo $PublicationId; ?>">   
