    ...
    <div class="accordion-group">
        <div class="accordion-heading">
            <a  class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapse_<?php echo str_replace(" ","",$Intersts); ?>">
                <?php echo str_replace("Interests"," Interests",$Intersts); ?> <i data-original-title="Type a word then press enter key" rel="tooltip" data-placement="bottom" data-id="cvid" style="font-weight: normal;top:7px;right:auto;float:left;margin-left:5px;" class="fa fa-question helpmanagement helpicon top10  tooltiplink"></i>
            </a>
            <div class="sectionremove"  data-placement="bottom" rel="tooltip"  data-original-title="Remove section" onclick="removeSection('<?php echo $InterestId; ?>', '<?php echo str_replace(" ","",$Intersts); ?>', 'In_dropdown', 'Interests','')"><i class="fa fa-times"></i>
            </div>
        </div>
