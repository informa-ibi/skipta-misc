...
<div class="disease_topicssectiondiv topicsClass category_<?php echo $obj->CategoryId?> " >
                                                ...
                                                <a class="pull-left marginzero smallprofileicon"><img src="<?php echo $obj->ProfileImage;?>"></a>
                                                </div>
...
<a class="follow_a"  style="cursor:default"><i><img data-original-title="No.Of Posts" rel="tooltip" data-placement="bottom" class=" tooltiplink d_conversations" src="/images/system/spacer.png" /></i> <b id="leftmenuPostsCount_<?php echo $obj->CategoryId; ?>"><?php echo $obj->NumberOfPosts;?></b></a>
<a class="follow_a"  style="cursor:default"><i><img data-original-title="Followers" rel="tooltip" data-placement="bottom" class=" tooltiplink d_followers" src="/images/system/spacer.png" /></i> <b id="leftmenuFollowersCount_<?php echo $obj->CategoryId; ?>" ><?php echo count($obj->Followers);?></b></a>
                                                </div>
                                                    </div>
                                                </div>
             ...
             <?php if($categoriescount>5) { ?>
                           <div class="alignright clearboth paddingr10"> <a class="more" href="/disease/topics">more <i class="fa fa-youtube-play"></i></a></div>
