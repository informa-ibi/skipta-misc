...
<div style="position: relative">
        ...
        <div class="tablehead pull-left" >
                  ...
                  <div rel="tooltip" style="cursor: pointer;" onclick="createNewHelpIconDescription()" role="button"  data-toggle="tooltip" title="Create Help">
            ...
            <div class="tabletopcorner">
                 ...
                 <div class="tabletopcorner">
                 <select id="filterHelpIconDescriptionTitle" class="styled textfield">
                    <option value="all">
                        All
                    </option>
                    <option value="active">
            ...
            <div id="tablewidget"  style="margin: auto;">
             <table class="table table-hover">
                    ...
                    <td>  
                       {{if Status != 0}}
                        <a id="editButton_{{>Id}}" rel="tooltip" style="cursor: pointer;" onclick="editHelpIconDescriptionById('{{>Id}}','{{>Name}}')" role="button"  data-toggle="tooltip" title="Edit" > <i class="fa fa-pencil-square"></i></a> 
                       {{/if}}                     

                        <a rel="tooltip" style="cursor: pointer;" onclick="changeHelpIconDescriptionStatus('{{>Id}}','Status')" role="button"  data-toggle="tooltip" title="Change Status" > <i class="icon-place-renewstatus"></i></a> 
                    </td>
                </tr>
                {{/for}}
            </tbody>
