...
<div style="position: relative">
        ...
        <div class="tablehead pull-left" >
                  ...
                  <div rel="tooltip" style="cursor: pointer;" onclick="createNewCurbsideCategory()" role="button"  data-toggle="tooltip" title="Create Category">
            ...
            <div class="tabletopcorner">
                 ...
                 <div class="tabletopcorner">
                 <select id="filterCurbsideCategory" class="styled textfield">
                    <option value="all">
                        All
                    </option>
                    <option value="active">
