<script  id="commentTmpl_render" type="text/x-jsrender">
  ...
  <div class="commentsection">
   ...
   {{if ResourceLength > 2}}
    ...
    <a  class="pull-left  pull-left1 img_more postdetail" data-profile="{{>Profilename}}" data-id="{{>streamId}}" data-postid="{{>PostId}}" data-categoryType="{{>CateogryType}}" data-postType="{{>Type}}">

    
          
           {{else}} 
 <a  class="pull-left img_single postdetail" data-profile="{{>Profilename}}" data-id="{{>streamId}}" data-postid="{{>PostId}}" data-categoryType="{{>CateogryType}}" data-postType="{{>Type}}">
        {{/if}}
