        ...
        <div  class="block">
            ...
            <div id="tablewidget" style="margin: auto;">
                ...
                <table class="table table-hover">
                    ...
                    <thead><tr><th>Name</th><th class="data_t_hide">Email</th><th  class="data_t_hide">User Type</th><th>Status</th><th class="data_t_hide">Registered Date</th><th>Actions</th></tr></thead>
                    <tbody>
                   ...
                   <tbody>
                        {{for data}}
                            ...
                            <tr>
                             ...
                             <tr>
                                <td class="l_label">ISLicensedNephrologist </td>
                                <td class="t_b ">:{{if ISLicensedNephrologist == 0}} No {{else ISLicensedNephrologist == 1}} Yes {{/if}}</td>
                            </tr>
                            {{if ISLicensedNephrologist == 1}}
                            <tr>
                                <td class="l_label">StateLicenseNumber </td>
                                <td class="t_b ">:{{>StateLicenseNumber}}</td>
                             </tr>
                            {{/if}}
                             {{if ISLicensedNephrologist == 0 && AboutYou != "" && AboutYou != null && AboutYou != 'null'}}
                            <tr>
                                <td class="l_label">AboutYou </td>
                                <td class="t_b ">: {{>AboutYou}}</td>
                             </tr>
                            {{/if}} 
                                    
                                    
                            <tr>
                            {{if Subspeciality != 'Other' && Subspeciality != "" && Subspeciality != null && Subspeciality != 'null'}}
                                <td class="l_label">Subspeciality </td>
                                <td class="t_b ">: {{>Subspeciality}}
                                </td>
                                {{else OtherSubspeciality != "" && OtherSubspeciality != null && OtherSubspeciality != 'null'}}
                                <td class="l_label">Other Affiliation </td>
                                <td class="t_b ">: {{>OtherSubspeciality}}</td>
                             {{/if}}
                            </tr>
                            <tr>
