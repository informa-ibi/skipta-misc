...
function bindGroupsFollowUnFollow(pageId){      
     $("#followGroupInDetail img.followbig").live( "click",
        function(){ 
            var content="If you unfollow Toolbox all the subtoolboxes under this Toolbox will be unfollowed.";
            var groupId = $(this).closest('span.noborder').attr('data-groupid');        
            var param ={groupId:groupId,type:"UnFollow",obj:this};
            openModelBox("error_modal", "Toolbox", content, "NO", "Yes", followOrUnfollowGroupFromDetail, param);
...
function deleteGroup(groupId) {
    g_groupId = groupId;
    ("groupfollowSpinLoader");
    var queryString = "groupId=" + groupId;   
    ajaxRequest("/group/DeleteGroup", queryString);
}