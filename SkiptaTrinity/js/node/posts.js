var config = require('SkiptaTrinity');
...
//                    logger.trace('stderr: ' + data);
    ...
    socket.on('getNewPostsRequest', function(postdt, userId, userTypeId,postAsNetwork,socketId,timezoneName,jObject) {
        g_postDT = postdt;
              ...
              child = spawn(dir+"/yiicVD", ['ncom', 'getNewPosts', '--date=' + g_postDT, '--userId=' + userId, '--userTypeId=' + userTypeId,'--postAsNetwork='+postAsNetwork,'--timezoneName='+timezoneName]);    
              }
...
//            logger.trace('stderr: ' + data);
    ...
    socket.on('getLatestPostsRequest', function(userId,userTypeId,postAsNetwork,socketId,timezoneName,project) {
        if(project=='Trinity'){
           ...
           child = spawn(dir+"/yiicVD", ['ncom', 'getLatestPosts', '--userId=' + userId, '--userTypeId=' + userTypeId,'--postAsNetwork='+postAsNetwork,'--timezoneName='+timezoneName]);           
        }
...
//            logger.trace('stderr: ' + data);
    ...
    socket.on('getTopicsRequest', function(topicIds,loginUserId,socketId,jsonObject) {    
        jobject = JSON.parse(jsonObject)
        
            if(jobject.project=='Trinity'){
             child = spawn(dir+"/yiic", ['ncom', 'getTopics', '--topicIds=' + topicIds, '--loginUserId=' + loginUserId]);   
           }else{
              child = spawn(dir+"/yiicVD", ['ncom', 'getTopics', '--topicIds=' + topicIds, '--loginUserId=' + loginUserId]);
          }
     ...
     socket.on('GetNewGroupPostsRequest', function(postdt, userId, userTypeId,type,groupId,socketId,timezoneName,jsonObject) {
          jobject = JSON.parse(jsonObject)
            ...
            if(jobject.project=='Trinity'){
              ...
              child = spawn(dir+"/yiicVD", ['ncom', 'getNewGroupPosts', '--date=' + postdt, '--userId=' + userId, '--userTypeId=' + userTypeId,'--type='+type,'--id='+groupId,'--timezoneName='+timezoneName]);  
            }
...
//            logger.trace('stderr: ' + data);
    ...
    socket.on('getLatestGroupPostRequest', function(userId,groupId, userTypeId,type,postAsNetwork,socketId,timezoneName,project) {
          if(project=='Trinity'){
        ...
        child = spawn(dir+"/yiicVD", ['ncom', 'getGroupLatestPosts', '--userId=' + userId, '--groupId=' + groupId, '--userTypeId=' + userTypeId,'--type='+type,'--postAsNetwork='+postAsNetwork,'--timezoneName='+timezoneName]);
...
//            logger.trace('stderr: ' + data);
    ...
    socket.on('getUpdatedStreamPostRequest', function(userId,streamId,userTypeId,pageType,socketId,timezoneName,project) {
       if(project=='Trinity'){
        ...
        child = spawn(dir+"/yiicVD", ['ncom', 'getUpdatedStreamPost', '--userId=' + userId,'--streamId=' + streamId, '--userTypeId=' + userTypeId,'--pageType='+pageType,'--timezoneName='+timezoneName]);   
       }
...
/* news */
 socket.on('clientRequest4news', function(postids,socketId,jsonObject) {
      jobject = JSON.parse(jsonObject);
          ...
          child = spawn(dir+"/yiicVD", ['ncom', 'newsRequest', '--postIds=' + postids]);
            }
 ...
 socket.on('clientRequest4Game', function(postids,socketId,jsonObject) {
     jobject = JSON.parse(jsonObject);
      ...
      if(jobject.project=='Trinity'){
          ...
          child = spawn(dir+"/yiicVD", ['ncom', 'gameRequest', '--postIds=' + postids]);
      }
