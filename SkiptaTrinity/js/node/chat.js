...
//    });
    ...
    client.on('getUserFriends', function(userId, searchText,startLimit,pageLength,callback,userIdsArray,socketId,project)
    {  
        ...
        child = spawn(dir+'/yiicVD', ['chat', 'getFriends', '--userId=' + userId, '--logginedUsers=' + userIdsArray, '--searchText=' + searchText,'--startLimit=' + startLimit,'--pageLength=' + pageLength]);    
        }
     ...
     client.on('searchUsers', function(userId, searchText,startLimit,pageLength,callback,userIdsArray,socketId,project)
    {  //logger.tracer("searchUsers---------------------------"+userId+"--"+userIdsArray);
        ...
        child = spawn(dir+'/yiic', ['chat', 'searchUsers', '--userId=' + userId, '--logginedUsers=' + userIdsArray, '--searchText=' + searchText,'--startLimit=' + startLimit,'--pageLength=' + pageLength]);    
         ...
         child = spawn(dir+'/yiicVD', ['chat', 'searchUsers', '--userId=' + userId, '--logginedUsers=' + userIdsArray, '--searchText=' + searchText,'--startLimit=' + startLimit,'--pageLength=' + pageLength]);    
        }
    ...
    client.on('getOfflineMessages', function(loginUserId, callback,socketId,project)
    { // console.log("getOfflineMessages---------------------------"+loginUserId);
        ...
        if(project=="Trinity"){
            child = spawn(dir+"/yiic", ['chat', 'getOfflineMessages', '--loginUserId=' + loginUserId]);
             ...
             child = spawn(dir+"/yiicVD", ['chat', 'getOfflineMessages', '--loginUserId=' + loginUserId]);
        }
