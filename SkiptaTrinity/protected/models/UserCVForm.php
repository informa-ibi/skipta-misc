...
class UserCVForm extends CFormModel {
    ...
    public $ExperiencePriority;
    public $InterestsPriority;
    public $PublicationsPriority;
    public $AchievementsPriority;
    /**
        ...
        if(sizeof($this->$params['fieldname'])>0){
           foreach ($this->$params['fieldname'] as $key => $order) {
            ...
            if (empty($order)) {
                ...
                $this->addError($params['fieldname'] . '_' . $key, $message . ' '.Yii::t('translation','cannot_be_blank'));
                // break;
            }
        }  
        }
            ...
            foreach ($this->$params['fieldname'] as $key => $order) {
                ...
                if($link!=""){
                    ...
                    if($this->PublicationFIleType[$key]==1){
                     ...
                     $this->addError($params['fieldname'] . '_' . $key,  $params['fieldname'] . ' '.Yii::t('translation','link_is_invalid').' '.Yii::t('translation','pdf_xls_doc_extension_to_be_allowed'));
                }
