...
//              $modifier->addModifier('UserAnswers.$.Points', 'set', (int)$points);
             ...
             Yii::log("in saveAnswer".$ex->getMessage(),'error','application');
          }
      }
      public function checkUserAnswered($userId,$gameId,$gameScheduleId,$questionId){
         try{
            ...
            if(is_object($obj)){
             ...
             Yii::log("in checkUserAnswered".$ex->getMessage(),'error','application');
         } 
      }
     public function submitGame($userId,$gameId,$gameScheduleId, $totalTimeSpent=0){
      ...
      public function findUserGameStatus($userId,$scheduleGameId,$startDate=''){
       ...
       Yii::log($ex->getLine()."in findUserGameStatus  ".$ex->getMessage(),'error','application');
...
//            }else{
           ...
           // }
              ...
              error_log("excpetion-----------findUserGameStatusForPreviousSchedule--------".$ex->getMessage());
       Yii::log("in findUserGameStatusForPreviousSchedule".$ex->getMessage(),'error','application');
