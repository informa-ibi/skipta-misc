        ...
        try {
            ...
            $array = array(
             ...
             if($UserId!="")
             {
                 ...
                 error_log("===ssssssssssssssssss======1=========================");
              $array = array(
                'conditions' => array(
                    'NetworkName' => array('==' => $networkName),
             ...
             error_log("=====ssssssssssssssssssssss====2=========================");
           ...
           // $mongoCriteria->addCond("CreatedOn", "<=", new MongoDate(strtotime($endDate)));
            ...
            $result=  DSNNotificationCollection::model()->findAll($mongoCriteria);
             ...
             error_log(strtotime($endDate)."in getdsn comon notification".print_r($result,true));
             return $result;
        } catch (Exception $exc) {
            error_log("Exception  _________________".$exc->getMessage());
