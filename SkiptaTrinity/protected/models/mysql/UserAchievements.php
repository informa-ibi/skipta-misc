 ...
 public $Achievement_Priority;
    ...
    public function saveUserCVAchievementDetails($educationModel,$UserId) {
        try {
            ...
            $finalArray = array();
             $AchievementPriority=$educationModel['AchievementsPriority'];
            ...
            foreach ($finalArray as $key => $value) {
                ...
                $userObj->Priority = $i;
                $userObj->Status = 1;
                $userObj->Achievement_Priority = $AchievementPriority;
            if ($userObj->save()) {
            ...
            if (sizeof($result) > 0) {
                foreach ($result as $key => $value) {
                    ...
                    $finalArray[$key]['Achievement'] = $educationDetails['Achievement'];
                     $finalArray[$key]['Achievement_Priority'] = $value['Achievement_Priority'];
                }
    ...
    public function updateUserCVAchievementDetails($educationModel,$UserId){
         ...
         try {
            ...
            if (isset($educationObj)) {
                ...
                $educationObj->Achievement_Priority = $AchievementPriority;
