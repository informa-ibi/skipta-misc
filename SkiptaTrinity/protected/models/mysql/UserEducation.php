...
class UserEducation extends CActiveRecord {
    ...
    public function saveUserCVEducationDetails($educationModel,$UserId) {
        try {
            ...
            $finalArray = array();
            $EducationPriority=$educationModel['EducationPriority'];
          if(trim($educationModel['Education'])!=""){
            ...
            foreach ($finalArray as $key => $value) {
                ...
                $userObj->Priority = $i;
                $userObj->Status = 1;
                $userObj->Education_Priority = $EducationPriority;
            if ($userObj->save()) {
      ...
      try {
            ...
            if (sizeof($result) > 0) {
                foreach ($result as $key => $value) {
                    ...
                    $finalArray[$key]['Education_Priority'] = $value['Education_Priority'];
                }
   ...
   public function updateUserCVEducationDetails($educationModel,$UserId){
          ...
          $returnValue = false;
            ...
            if (isset($educationObj)) {
                ...
                $educationObj->Education_Priority = $EducationPriority;
