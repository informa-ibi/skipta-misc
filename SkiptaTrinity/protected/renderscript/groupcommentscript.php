<script  id="groupcommentTmpl_render" type="text/x-jsrender">
  ...
  <div class="commentsection">
   ...
   {{if ResourceLength > 1}}
    ...
    <a  class="pull-left  pull-left1 img_more postdetail" data-postid="{{>PostId}}" data-categoryType="{{>CategoryType}}" data-postType="{{>Type}}">
   {{else}} 
   <a  class="pull-left img_single postdetail" data-postid="{{>PostId}}" data-categoryType="{{>CategoryType}}" data-postType="{{>Type}}">
        {{/if}}
