            ...
            <div id="invite_{{>id}}" class="paddinglrtp5" >
                <div class="row-fluid  ">
                    <div class="span12 success">
                        <label ><?php echo Yii::t('translation','Mentions'); ?></label>                        
                        <input type="text" id="inviteTextBox_{{>id}}" class="span12 textfield " maxlength="50" placeholder=""> 
                        <div class="control-group controlerror">
                            <div style="display: none;" id="InviteTextBox_{{>id}}_em_" class="error errorMessage"><?php echo Yii::t('translation','Mention_atleast_one_user'); ?></div>
                    <div style="display: none;" id="InviteTextBox_{{>id}}_em_propermention" class="error errorMessage">Please select valid mention from suggestions.</div>
                        </div>
                    </div>
                </div>
                <div class="row-fluid  ">
                    <div class="span12 success">
                        ...
                        <div class="control-group controlerror">
                            <div style="display: none;" id="InviteTextArea_{{>id}}_em_" class="error errorMessage"><?php echo Yii::t('translation','Message_cannot_be_blank'); ?></div>
                        </div>
                    </div>
                </div>
                <div class="headerbuttonpopup h_center padding8top">
                    <div class="alignright">
                        <button id="saveInviteButton_{{>id}}" onclick="saveInvites('{{>PostId}}',{{>NetworkId}},{{>CategoryType}},'{{>id}}');" class="btn btn-2 btn-2a" ><?php echo Yii::t('translation','Invite'); ?></button>
                        <button class="btn btn_gray " onclick="cancelInvite('{{>id}}')" id="cancelInviteButton_{{>id}}"> <?php echo Yii::t('translation','Cancel'); ?></button>            
                    </div>
            </div>
            </div>
        </div>
