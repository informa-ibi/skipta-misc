    ...
    public function SaveUserCollection($userProfileform,$customForm){
     try {
        ...
        if(isset($userId) && $userId!='error'){ 
         ...
         $userCollectionModel->CountryId=(int) $Networkobj['Id'];
...
//                UserProfileCollection::model()->updatePassword
    ...
    if($value==1){
            ...
            error_log("=====updateUserStatus====service=======" . $ex->getMessage());
 ...
 */
    public function getUserByType($value,$type){
     ...
     public function getTinyUserCollection($userId){
         try {
             ...
             error_log("_____________________________in service________________");
             Yii::log($exc->getMessage(),'error','application');
         }
          }
  ...
  public function getUserProfileDetails($userId,$loggedInUserId){
      try {   
       ...
       $userstate=State::model()->GetStateName($userDetailsfromMysql['State'],$userDetailsfromMysql['Country']);
       if(isset($userstate['State'])){
 ...
 */    
  ...
  /* This Method is used for update the user profile in both mysql and mongo 
      it accepts userprofileForm obj and customForm Obj
  *   */     
    public function UpdateUserCollection($userProfileform,$oldUserObj,$updateCountry){
     try {
         $userCollectionModel=new UserCollection();
...
//         }
 ...
 //        $userCollectionModel->NetworkId=(int)$NetworkId;
         ...
         $userCollectionModel->uniqueHandle=$uniqueHandle;
           ...
           UserCollection::model()->updateUserCollection($userCollectionModel,$updateCountry); 
         }
...
error_log("____SkiptaUserService:saveUserCVPublicationCollection::___".$ex->getMessage());
        }
...
//           $userProfileform['network']=$NetworkId;
    ...
    public function getAllSegmentsByNetwork($networkId){
        ...
        try {
          ...
          Yii::log("_________SkiptaUserService/getAllSegmentsByNetwork___________",'error','application');
        }
        return $returnValue;
    }
    public function updateSegmentByUserId($userId, $segmentId){
        ...
        try {
          ...
          Yii::log("_________SkiptaUserService/updateSegmentByUserId___________",'error','application');
        }
        return $returnValue;
    }
    public function getAllLanguages(){
        ...
        try {
          ...
          Yii::log("_________SkiptaUserService/getAllLanguages___________",'error','application');
        }
        return $returnValue;
    }
    ...
    public function getLanguageByAttributes($attributeArray){
        ...
        try {
          ...
          Yii::log("_________SkiptaUserService/getLanguageByAttributes___________",'error','application');
        }
        return $returnValue;
    }
     public function getSegmentByAttributes($attributeArray){
        ...
        try {
          ...
          Yii::log("_________SkiptaUserService/getSegmentByAttributes___________",'error','application');
        }
        return $returnValue;
    }
     public function requestForChangeCountry($preferenceFormObj,$userId) {
        try {
            if(isset($preferenceFormObj['CountryId']))
            {
               $countryObj= Countries::model()->getCountryById($preferenceFormObj['CountryId']);
               if(isset($countryObj) && isset($countryObj->NetworkId))
               {
                    $return= User::model()->requestForChangeCountry($userId, $preferenceFormObj['CountryId']);
                    return $return;
               }
            }
        } catch (Exception $exc) {
  ...
  public function updatePushNotification($userId){
    ...
    public function getUserAttendingEventsForRightWidget($userId,$CurrentLoginDate, $segmentId=0) {
         try {
            $returnValue = 'failure';       
            $userEventAttendingActivities=  UserStreamCollection::model()->getUserAttendingEventsActivity($userId,$CurrentLoginDate, $segmentId);
                if(count($userEventAttendingActivities)>0){
                  $returnValue = $userEventAttendingActivities;   
                }
            return $returnValue; 
    ...
    //  error_log("--------getActionUsers-----------id--".$id."--flag--".$flag."--cate".$categoryId."--action---".$actionType);
      try{
       ...
       if (count($actionUsers_chunck)>0) {
        ...
        return $finalArray;
        //error_log("getActionUsers-- result--".print_r($finalArray));
      } catch (Exception $ex) {
     Yii::log($ex->getMessage(), 'error', 'application');
      }
       ...
       public function checkNetworkLogin($authToken,$userId) {
         try {
             ...
             error_log("restul------".sizeof($result));
             if (sizeof($result) > 0) {
               return TRUE;
            }else{
                return FALSE;
   ...
   public function getCustomFieldsByUserId($UserId) {
     ...
     public function getCustomFormByUserId($UserId) {
        ...
        error_log(print_r($customForm,true));
        return $returnValue; 
    }
...
public function getCustomSubSpeciality() {
        try {
            ...
            if(is_array($subSpe) || is_object($subSpe)){
                ...
                if(Yii::app()->params['NetworkName']!="Neurologist Connect"){
    ...
    public function getCustomFieldsByUserIdforSurveyReports($userId){
        try{
            ...
            Yii::log("---getCustomFieldsByUserId-" . $ex->getMessage(), 'error', 'application');
            return $returnValue;
        }
    }
    public function getAllNotLoggedInUsersFromPastFourdays() {
         try {
            ...
            Yii::log("-----------in exception--------getAllNotLoggedInUsersFromPastFourdays------------".$exc->getMessage(),'error','application');
        }
     ...
     public function getUserAwayDigest($userId) {
         try {
            ...
            Yii::log("-----------in exception--------saveOrUpdateUserAwayDigest------------".$exc->getMessage(),'error','application');
        }
     ...
     public function getAwayDigestSentUserListFromPastFourDays() {
         try {
            ...
            Yii::log("-----------in exception--------getAwayDigestSentUserList------------".$exc->getMessage(),'error','application');
        }
     ...
     public function saveOrUpdateAwayDigest($postId,$postType,$categroyType,$isUseforDigest) {
         try {
            ...
            Yii::log("-----------in exception--------saveOrUpdateAwayDigest------------".$exc->getMessage(),'error','application');
        }
     ...
     public function getAwayDigestListFromLstSevenDays($isMarkedByAdmin){
         try {
            ...
            Yii::log("-----------in exception--------getAwayDigestListFromLstSevenDays------------".$exc->getMessage(),'error','application');
        }
    ...
    public function updateUserProfileDetailsByUsingUserId($UserProfileModel) {
        try {
           ...
           //  if($UserProfileModel['UserInterests']!=""){
            ...
            // }
             if($usercollectionDetails!='failure' && $userdetails!='failure'  && $UserProfessionalInformation!='failure' && $userInterests!='failure'){
                 $returnValue='success';
...
*/ 
    ...
    public function saveUserAchievements($UserProfileModel) {
        try{
            ...
            error_log('==============SkiptaUserService/saveUserAchievements===========' . $ex->getMessage());
        }
...
public function geHDSUserDetailsByUserId($AccessId) {
    try {
        ...
        Yii::log("Exception occurred in geHDSUserDetailsByUserId in SkiptaUserService layer=" . $ex->getMessage(), "error", "application");
    }
    return $userProfileObject;
}
/*@Author Haribabu
...
public function updateHDStUserDetailsByAccessId($AccessId,$field,$value) {
    try {
        ...
        Yii::log("Exception occurred in updateHDStUserDetailsByAccessId in SkiptaUserService layer=" . $ex->getMessage(), "error", "application");
    }
    return $userProfileObject;
}
  ...
  *   */     
    public function SaveHdsUserCollection($HdsUserprofileDetails,$UserDetails){
     try {
        ...
        $UserprofileDetails['country'] = $UserDetails->Country;
        ...
        $UserprofileDetails['pass']=$HdsUserprofileDetails['password'];
         ...
         if(isset($UserprofileDetails['country']))
         {
          $NetworkId= Network::model()->getNeworkId($UserprofileDetails['country']);
           (isset($NetworkId) && $NetworkId!='error')?'':$NetworkId=1;               
           $UserprofileDetails['network']=$NetworkId;
         }
        ...
        if(isset($userId) && $userId!='error'){ 
         ...
         Yii::log("---getCustomFieldsByUserId-" . $exe->getMessage(), 'error', 'application');
         error_log("SkiptaUserService/SaveHdsUserCollection===".$exe->getMessage());
     }
  }
/*@Author Haribabu
...
public function getHdsUsersDataByUsingStatus($Status) {
    try {
        ...
        Yii::log("Exception occurred in getHdsUsersDataByUsingStatus in SkiptaUserService layer=" . $ex->getMessage(), "error", "application");
    }
    return $userProfileObject;
}
...
public function getAllNewUsersEligableForNewUserSurvey($noOfDays){
    ...
    public function getAllActiveUsers(){
     ...
     public function getAllUsersLat() {
         try {
            ...
            Yii::log("-----------in exception--------getAllUsers------------".$exc->getMessage(),'error','application');
        }
    ...
    public function getAllSurveyEligableActiveUsers($surveydays){
        try{
            ...
            Yii::log("---getAllSurveyEligableActiveUsers-" . $ex->getMessage(), 'error', 'application');
            return $returnValue;
        }
    }
}
