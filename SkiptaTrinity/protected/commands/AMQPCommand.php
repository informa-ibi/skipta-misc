    ...
    public function activities($obj) {
        try{
           ...
           $this->saveOrUpdateNotifications($obj);
            ...
            if ($obj->ActionType == 'Follow' || $obj->ActionType == "UnFollow" || $obj->ActionType == 'UserFollow' || $obj->ActionType == 'UserUnFollow' || $obj->ActionType == 'GroupFollow' || $obj->ActionType == 'GroupUnFollow' || $obj->ActionType == 'SubGroupFollow' || $obj->ActionType == 'SubGroupUnFollow' || $obj->ActionType == "HashTagUnFollow" || $obj->ActionType == "CurbsideCategoryFollow" || $obj->ActionType == "CurbsideCategoryUnFollow") {
   ...
   public function achievements($userAchievementsObj) {
    ...
    public function saveUserAchievements($userAchievementsObj) {
        try {
            ...
            Yii::log("=================AMQP/saveUserAchievements=========".$exc->getMessage(), 'error', 'application');
        }
    }
    public function saveNewUserAchievements($userAchievementsObj) {
        try {
            ...
            Yii::log("=================AMQP/saveNewUserAchievements=========".$exc->getMessage(), 'error', 'application');
        }
    }
...
//                               }
            ...
            Yii::log("=================AMQP/updateEngagementDriversAvailabilityForUser=========".$exc->getMessage(), 'error', 'application');
        }
    }
    ...
    public function updateTourGuideStatus($userAchievementsObj)
    {
        try
        {
            ...
            Yii::log("=================AMQP/updateTourGuideStatus=========".$ex->getMessage(), 'error', 'application');
        }
    }
...
//                            $this->savePostNotifications($obj, ' posted a curbside consult using a ' . $categoryObj->CategoryName .' that you are following.',"", 'post', $notifiObj,$follower);
                ...
                if ($obj->PostType == 12 && $obj->CategoryType == 9 && $obj->PreviousGameScheduleId != 0 && $obj->ActionType == "Post") {
                    ...
                    if($obj->CategoryType!=11 && $obj->CategoryType!=9 && $obj->CategoryType!=14)
                    {
    ...
    function distributeStreamForComment($obj) {
        try {
            ...
            echo "distributeStreamForComment" . $exc->getMessage();
     ...
     */
     ...
     function distributeStreamForFollowObject($obj) {
        try {
            ...
            echo "***EXCEPTION**" . $exc->getTraceAsString();
        }
    }
...
//                
    ...
    try {            
            ...
            $isFollowing = 0;
                        ...
                        echo '_________SAVE NOTIFICATION_____' . $exc->getMessage();
                    }
}
...
//    
                ...
                if ($userSettings != "failure") {
                    if ($userSettings->UserFollowers == 1) {
                        try {
                            ...
                            echo '________Exception__________' . $exc->getMessage();
                        }
                    }
                }
            }
        } catch (Exception $exc) {
            echo '_______Exception NOTification__________' . $exc->getMessage();
        }
    }
    ...
    public function saveUserFollowNotifications($obj, $NetworkId,$userId) {
        ...
        try {
            ...
            echo '_________ UserFollowNotifications_______' . $exc->getMessage();
        }
    }
...
//         }
    ...
    public  function saveFollowObjectForNotificationsFromGroupAndSubGroup($obj) {
        try {
            ...
            echo "EXCEPTION saveFollowObjectForNotificationsFromGroupAndSubGroup " . $exc->getMessage();  
        }
    }
    ...
    public  function upateNewsToNotifyInStream($obj) {
        try {
            ...
            UserInteractionCollection::model()->updatePostManagementActions($obj);
             ...
             echo "EXCEPTION upateNewsToNotifyInStream " . $exc->getMessage(); 
            Yii::log($exc->getMessage(), 'error', 'application');
        }
    }
...
//                  //  $returnValue = UserProfileCollection::model()->followOrUnfollowGroup($obj->GroupId, $user->UserId, "Follow");
            ...
            echo "EXCEPTION GROUP Auoto follow " . $exc->getMessage(); 
        }
    }
    ...
    public  function suspendOrReleaseGame($obj) {
        try {
            ...
            echo "exception suspendOrReleaseGame" . $exc->getMessage();
        }
    }
    ...
    public  function ScheduleGame($obj) {
        try {
            ...
            echo "exception ScheduleGame" . $exc->getMessage();
        }
    }
    /**
     * @author M Vamsi Krishna
