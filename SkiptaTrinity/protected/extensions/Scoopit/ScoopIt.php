...
class ScoopIt {
	public $scitServer="http://www.scoop.it/";
	public $scitRequestTokenUrl;
	public $scitAccessTokenUrl;
	public $scitAuthorizeUrl ;
	...
	// Main authentication job is done here !
	public function login($accessToken,$secret,$requestToken){
