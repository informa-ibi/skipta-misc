...
class DatamigrationController extends ERestController {
    ...
    public function actionUser($args = null) {
        ...
        try {
            ...
            error_log("==in exception====" . $exc->getMessage());
        }
    ...
    public function actionUserFollowing() {
        try {
            ...
            error_log("Exception Occurred in actionGetUserManagementDetails==" . $e->getMessage());
        }
    }
...
//Process Sheets Data and Persist
    ...
    public function actionSaveCurbsidePost() {
        try {
            ...
            Yii::log("-----exception in actionCurbsidePostSaving--------" . $ex->getMessage(), "error", "application");
        }
    }
    ...
    public function actionSaveGroups() {
        try {
            ...
            Yii::log("-----exception in actionSaveGroups--------" . $ex->getMessage(), "error", "application");
        }
    ...
    public function actionSaveGroupsFollowers() {
        try {
            ...
            Yii::log("-----exception in actionSaveGroupsFollowers--------" . $ex->getMessage(), "error", "application");
        }
        $message = "followers Ids saved success";
        echo $message;
    }
...
//                        $text = $header['url'];
    ...
    public function actionCreateGroupPost() {
        try {
            ...
            echo "GroupPost Saving Fail Exception===" . $exc->getMessage();
        }
    }
    ...
    public function actionSaveActionsToPost() {
        try {
            ...
            echo "Action Saving Fail Exception===" . $exc->getMessage();
        }
    }
    ...
    public function actionCreateGame() {
        try {
            ...
            echo "Exception in Create Game" . $ex->getMessage();
        }
    }
