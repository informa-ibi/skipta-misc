  ...
  if(Yii::app()->session['IsAdmin']==1)
    {
       $this->whichmenuactive = 8;
        ...
        $CuratedDataFromDB = ServiceFactory::getSkiptaPostServiceInstance()->getCuratedTopicsService(Yii::app()->session['UserStaticData']->UserId, 1);       
    ...
    public function actionGetgameabusedposts(){
        try{
            ...
            Yii::log("Exception Occurred in actionGetgameabusedposts==".$ex->getMessage(),"error","application");
        }
    }
    public function actionGetnewsabusedposts(){
        try{
            ...
            Yii::log("Exception Occurred in actionGetnewsabusedposts==".$ex->getMessage(),"error","application");
        }
    }
     /**
     * @author Haribabu
    ...
    public function actiongetGroupsInactiveActive() {
        try {
            ...
            Yii::log("Exception Occurred in groupsActiveAndInactive==" . $ex->getMessage(), "error", "application");
        }
    }
    public function actiongetGroupsInactive() {
        try {
            ...
            Yii::log("Exception Occurred in groupsActiveAndInactive==" . $exc->getMessage(), "error", "application");
        }
    }
    ...
    public function actiongetSubGroupsInactive() {
        try {
            ...
            Yii::log("Exception Occurred in actiongetSubGroupsInactive==" . $exc->getMessage(), "error", "application");
        }
    }
    ...
    public function actionBroadCastNotifications() {
        ...
        try {
            ...
            Yii::log("Exception Occurred in BroadCastMassge==" . $exc->getMessage(), "error", "application");
        }
    }
