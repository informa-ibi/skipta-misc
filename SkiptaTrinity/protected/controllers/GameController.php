...
public function __construct($id, $module = null) {
  ...
  public function actionIndex(){
      try {
          ...
          // error_log("game love-----".print_r($lovefollowArray,true));
           }
           //GameAds onload
...
//        $CurrentGame = ServiceFactory::getSkiptaGameServiceInstance()->getCurrentScheduleByScheduleId($gameDetails->_id);
//                   $date = CommonUtility::styleDateTime($CurrentGame->CreatedOn['sec']);
        $this->renderPartial('/post/post_search', array('postSearchResult' => $postSearchResult));
     }catch(Exception $ex){
         Yii::log("####Exception Occurred while hitting getGamesForSearch #########".$ex->getMessage());
     }
