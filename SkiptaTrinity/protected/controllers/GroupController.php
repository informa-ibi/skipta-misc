...
//                        $errorMessage = array('GroupCreationForm_FileName' => $message);
    ...
    public function saveUploadedFile($filename,$groupId,$groupName){
        try{
            ...
            error_log("############Exception Occurred while reading a csv file ##############".$ex->getMessage());
        }
    }
    ...
    public function actionDownloadFile() {
            try{
                ...
                Yii::log("===actionDownloadFile====".$exc->getMessage(), 'error', 'application');
            }
