...
if(isset($user_present) || Yii::app()->params['Project']=='Trinity') {
    ?>
...
<section id="streamsection" class="streamsection" >
 ...
 <div id="chatSpinLoader"></div>
        ...
        <div class="streamsectionarea <?php if ($this->sidelayout == 'yes') { ?>streamsectionarearightpanel<?php } ?> <?php if (Yii::app()->params['Menu']=='TOP') { ?>streamsectionareanoleftpanel<?php } ?>" id="contentDiv">
        <div class="padding10">
        <?php echo $content; ?>
        </div>
        </div>
