    ...
    <ul>
        <li class="media">
            ...
            <?php if(strlen($data->Editorial)>0){?>
                        <div class="clearboth newsPostInStreamPadding">                          
<!--                        <div class="decoratedNews" style="margin-top: 0px"><?php echo $data->Editorial?></div>-->
                        
                        
                        <div  class="padding10 decoratedNews EDCRO<?php echo $data->PostId?>" style="margin-top: 0px">
                        <?php
            ...
            <div class="clearboth newsPostInStreamPadding">
      <div  class="decoratedNews padding10 EDCROT<?php echo $data->PostId?>" style="margin-top: 0px;display: none" data-id="<?php echo $data->PostId;?>" data-postid="<?php  echo $data->PostId ?>" data-postType="11" data-categoryType="8">
          <div>
</div>
</div>
     </div>
...
<?php } ?>
              <div class="media-body" >
                  <div class="newsPostInStream"><?php echo $data->Title; ?></div>
                  
                   <div class="customcontentarea">
                      <div class="custfrom"><a href="<?php echo $data->PublisherSourceUrl ?>" target="_blank"><?php echo $data->PublisherSource ?></a></div>
                  </div>
