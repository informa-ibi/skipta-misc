<section id="Section_passwor_setup" class="streamsection network_specific">
    ...
    <div class="container">
        <div class="pad100">
                     <div class="alert-error" id="errmsgForPasswordSetUp" style='display: none'></div>
                    <div class="alert-success" id="sucmsgForPasswordSetUp" style='display: none'></div> 
...
function PasswordSetupHandler(data, txtstatus, xhr) {        
    ...
    if (data.status == 'success') {
        ...
        $("#sucmsgForPasswordSetUp").html(msg);
        $("#errmsgForPasswordSetUp").css("display", "none");
        $("#sucmsgForPasswordSetUp").css("display", "block");
        $("#paswordsetup-form")[0].reset();
        $("#sucmsgForPasswordSetUp").fadeOut(7000,function(){
