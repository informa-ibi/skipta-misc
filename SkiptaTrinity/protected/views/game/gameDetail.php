...
<img style="max-width:100%" src="<?php echo $gameDetails->GameBannerImage?>">
    ...
    <div id="gameDetailDiv" class="row-fluid">
     <div class="span6">
           <div class="gameNameBold" id="header_gameName_<?php echo $gameDetails->_id ?>"><?php echo $gameDetails->GameName?></div>
...
<script type="text/javascript">
    if(breadCumSource != ""){
          ...
          var url;
          if(sessionStorage.breadCumSource == "History"){
             $("#breadcrumSoureEle").html("Games");  
               sessionStorage.breadCumSource = "Games";
          }else{
             $("#breadcrumSoureEle").html(sessionStorage.breadCumSource);  
          }
         
          if(sessionStorage.breadCumSource == "Home"){
             url = "/stream"; 
          }else if(sessionStorage.breadCumSource == "Curbside"){
                url = "/curbsideConsult";
          }
          else if(sessionStorage.breadCumSource == "Groups"){
               url = "/groups";
          }
          else if(sessionStorage.breadCumSource == "Profile"){
              url = "/"+sessionStorage.prevURI;
          }
          else if(sessionStorage.breadCumSource == "Interactions"){
              url = "/"+sessionStorage.prevURI;
          }
          else if(sessionStorage.breadCumSource == "Games"){
              url = "/game/index";
          }
