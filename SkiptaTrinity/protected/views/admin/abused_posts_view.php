    ...
    <div class="post_widget" >
        <div class="stream_msg_box">
             <?php if($data->Type==2 || $data->Type==3){
                 ...
                 ?>
            <div class="stream_title paddingt5lr10" style="position: relative"> <a class="userprofilename" data-streamId="<?php echo $data->_id; ?>" data-id="<?php  echo $data->AbusedUserId?>"  style="cursor:pointer"><b><?php  echo $data->AbusedUserDisplayName?></b></a>  <?php  echo ($data->IsAbused==1)?"marked"."  ".$data->PostTypeString.$title." as Abuse":"$postTitle".$data->PostTypeString.$title.""; ?>  <?php  if ($data->Type==5){echo $data->CurbsideConsultTitle ?> <i><?php  echo $data->AbusedOn; ?></i><?php  }else{?><i><?php  echo $data->AbusedOn; ?></i><?php  }?>
              
                <?php if(!($data->DisplayType == "Block" && isset($data->IsBlockedWordExistInComment) && $data->IsBlockedWordExistInComment==1)){ 
                        if(($data->DisplayType == "Abuse" && $data->IsAbused) || $data->DisplayType == "Block"){
                    ?>
                ...
                <ul>
                    <li class="media">
                        ...
                        <?php  if($data->ArtifactIcon!=""){
                         ...
                         <a  class="pull-left img_single postdetail" data-posttype="<?php echo $data->Type ?>" data-categorytype="<?php echo $data->CategoryType ?>" data-postid="<?php echo $data->_id ?>" data-id="<?php echo $data->_id ?>"><div  class='<?php echo $videoclassName; ?>'><img src="/images/icons/video_icon.png"></div><img src="<?php  echo $data->ArtifactIcon ?>"  ></a>
                        <?php  }else{ ?>
                           <div class="pull-left multiple "> 
                                    <div class="img_more1"></div>
                                    <div class="img_more2"></div>
                             <a  class="pull-left  pull-left1 img_more postdetail" data-posttype="<?php echo $data->Type ?>" data-categorytype="<?php echo $data->CategoryType ?>" data-postid="<?php echo $data->_id ?>" data-id="<?php echo $data->_id ?>"><div  class='<?php echo $videoclassName; ?>'><img src="/images/icons/video_icon.png"></div><img src="<?php  echo $data->ArtifactIcon ?>"></a>  
        ...
        <?php   $categoryType = $data->CategoryType;
                if($data->IsCommentAbused){
                    include 'abusedComments.php';
                }else{
                    include 'blockedComments.php';
                }
        ?>
    </div>
</div>
