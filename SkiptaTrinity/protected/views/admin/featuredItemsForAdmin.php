    ...
    <div class="post_widget" >
        <div class="stream_msg_box">
            ...
            <div class="stream_title paddingt5lr10" style="position: relative"> <a class="userprofilename" data-streamId="<?php echo $data->_id; ?>" data-id="<?php  echo $data->UserId?>"  style="cursor:pointer"><b><?php  echo $data->OriginalUserDisplayName?></b></a> 
                ...
                if($data->CategoryType==1 || $data->CategoryType==8  ){
            ...
            <div class=" stream_content">
                <ul>
                    <li class="media">
                        ...
                        <a  class="pull-left img_single postdetail" data-posttype="<?php echo $data->Type ?>" data-categorytype="<?php echo $data->CategoryType ?>" data-postid="<?php echo $data->PostId ?>" data-id="<?php echo $data->PostId ?>"><img src="<?php  echo $data->ArtifactIcon ?>"  ></a>
                        <?php  }else{ ?>
                           <div class="pull-left multiple "> 
                                    <div class="img_more1"></div>
                                    <div class="img_more2"></div>
                             <a  class="pull-left  pull-left1 img_more postdetail" data-posttype="<?php echo $data->Type ?>" data-categorytype="<?php echo $data->CategoryType ?>" data-postid="<?php echo $data->PostId ?>" data-id="<?php echo $data->PostId ?>"><div  class='<?php echo $videoclassName; ?>'><img src="/images/icons/video_icon.png"></div><img src="<?php  echo $data->ArtifactIcon ?>"></a>  
                          ...
                          $extension = strtolower($data->Extension);
                           if($extension == 'mp4' || $extension == 'flv' || $extension == 'mov') {
                              ...
                              $videoclassName='videoThumnailNotDisplay';
                                        ...
                                        if($data->IsMultiPleResources==1){?>
                                          <a  class="pull-left img_single postdetail" data-posttype="<?php echo $data->Type ?>" data-categorytype="<?php echo $data->CategoryType ?>" data-postid="<?php echo $data->PostId ?>" data-id="<?php echo $data->PostId ?>"><div  class='<?php echo $videoclassName; ?>'><img src="/images/icons/video_icon.png"></div><img src="<?php  echo $data->ArtifactIcon ?>"  ></a>
                                           <?php  }else{ ?>
                                         <div class="pull-left multiple "> 
                                    <div class="img_more1"></div>
                                    <div class="img_more2"></div>
