        ...
        <div class="stream_msg_box">
            ...
            <div class=" stream_content positionrelative">
              ...
              <div class="bulletsShow" data-postid="<?php echo $data->PostId; ?>" data-id="<?php echo $data->_id;?>" id="post_content_total_<?php echo $data->_id; ?>" style="display:none">
                            ...
                            <div class="bulletsShow impressionDiv" data-postid="<?php echo $data->PostId; ?>" data-id="<?php echo $data->_id;?>" id="post_content_<?php echo $data->_id; ?>">
                            <?php  
                                  echo $data->PostText;
                             ?>
                                </div>
...
?>
<script type="text/javascript">
breadCumSource = "Curbside";
sessionStorage.breadCumSource = "Curbside";
</script>
