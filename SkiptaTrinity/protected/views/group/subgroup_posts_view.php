            ...
            <div class="stream_title paddingt5lr10" style="position: relative"> 
                ...
                ?></b></a><?php echo $data->SecondUserData ?> 
                    ...
                    <span class='userprofilename'> 
                                <?php if ($data->PostType == 2 || $data->PostType == 3) {
                    ...
                    <?php if ($data->PostType==5){
                                  echo $data->CurbsideConsultTitle ?> 
                    <i><?php  echo $data->PostOn; ?></i> 
                    <?php } else{ ?>
                    <i><?php  echo $data->PostOn; ?></i>
                    <?php }?>
...
<script>
 ...
 breadCumSource = "Sub Group"; 
  sessionStorage.breadCumSource = "Sub Group";
