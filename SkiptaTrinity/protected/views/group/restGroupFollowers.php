...
<?php } ?>
    ...
    <div class="span4">
        <div class="media" >
                  <a data-toggle="modal" data-name="<?php echo $follower->DisplayName?>" class="pull-left marginzero smallprofileicon profileDetails">
                      <img src="<?php echo $follower->profile250x250?>"> </a>
