    ...
    <div class="profilesummary" >
        <div class="media " >
            <a href="/<?php  echo $groupDetails->GroupUniqueName ?>" class="pull-left marginzero smallprofileicon profileDetails" style="cursor:pointer" data-userid="">
                <img   src="<?php echo $groupDetails->GroupIcon?>"></a>
