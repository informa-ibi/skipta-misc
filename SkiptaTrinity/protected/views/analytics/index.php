            ...
            <div class="span12 positionrelative">
                ...
                <div class="analytics_menu "> 
                    <ul id="tabs" class="" data-tabs="tabs">
                        ...
                        <li class="activity"  onclick="getActivityDetails('default')"   data-placement="bottom" rel="tooltip"  data-original-title="Assets" ><a href="#activity" data-toggle="tab"><img src="/images/system/spacer.png" /></a></li>
                                    ...
                                    if (isset($Topleaders['TopHashtags']) && count($Topleaders['Topusers']) > 0) {
                                        for ($i = 0; $i < count($Topleaders['Topusers']); $i++) {
                                            ...
                                            <li data-original-title="<?php echo $Topleaders['Topusers'][$i]['DisplayName']; ?>" rel="tooltip" data-placement="bottom" class="tooltiplink top_users ">
                                                <a data-userid="2" class="miniprofileicon miniprofileDetails floatL">  

                                                    <img src="<?php echo $Topleaders['Topusers'][$i]['ProfilePicture']; ?>">
                                                </a>
                                                &nbsp;&nbsp;<label style="float:left"><?php echo $Topleaders['Topusers'][$i]['DisplayName']; ?></label>
                                            </li>
...
<script type="text/javascript" language="javascript">
    ...
    var queryString1 = "startDate="+startDate+"&endDate="+endDate+'&GraphType=Post';

    ajaxRequest('/analytics/getActivityDetails', queryString1, function(data) {

        getActivityDetailsHandler(data,'chart_div');

    });
    var queryString2 = "startDate="+startDate+"&endDate="+endDate+'&GraphType=Curbside';

    ajaxRequest('/analytics/getActivityDetails', queryString2, function(data) {

        getActivityDetailsHandler(data,'chart_div2');

    });
   var queryString3 = "startDate="+startDate+"&endDate="+endDate+'&GraphType=Event';

    ajaxRequest('/analytics/getActivityDetails', queryString3, function(data) {

        getActivityDetailsHandler(data,'chart_div3');

    });
    var queryString4 = "startDate="+startDate+"&endDate="+endDate+'&GraphType=Survey';

    ajaxRequest('/analytics/getActivityDetails', queryString4, function(data) {

        getActivityDetailsHandler(data,'chart_div4');

    });
     var queryString5 = "startDate="+startDate+"&endDate="+endDate+'&GraphType=Featured';

    ajaxRequest('/analytics/getActivityDetails', queryString5, function(data) {

        getActivityDetailsHandler(data,'chart_div5');

    });


    var queryString6 = "startDate="+startDate+"&endDate="+endDate+'&GraphType=Promoted';

    ajaxRequest('/analytics/getActivityDetails', queryString6, function(data) {

        getActivityDetailsHandler(data,'chart_div6');

    });
    
    var queryString7 = "startDate="+startDate+"&endDate="+endDate+'&GraphType=News';

    ajaxRequest('/analytics/getActivityDetails', queryString7, function(data) {

        getActivityDetailsHandler(data,'chart_div7');

    });
    var queryString8 = "startDate="+startDate+"&endDate="+endDate+'&GraphType=Games';

    ajaxRequest('/analytics/getActivityDetails', queryString8, function(data) {

        getActivityDetailsHandler(data,'chart_div8');

    });
//     var queryString9 = "startDate="+startDate+"&endDate="+endDate+'&GraphType=Jobs';
//
//    ajaxRequest('/analytics/getActivityDetails', queryString9, function(data) {
//
//        getActivityDetailsHandler(data,'chart_div9');
//
//    });
     var queryString10 = "startDate="+startDate+"&endDate="+endDate+'&GraphType=GroupPost';

    ajaxRequest('/analytics/getActivityDetails', queryString10, function(data) {

        getActivityDetailsHandler(data,'chart_div10');
    ...
    function getActivityDetailsHandler(data1,divId) {
        ...
        for (var i = 0; i < data.getNumberOfColumns(); i++) {
         ...
         var options = {
                        ...
                        //   colors: ['#9ACD32', '#FFD700','#ff0000','#00FF00','#FF00FF','#008B8B','#1E90FF','#FF69B4','#800080','#A0522D','#4682B4','#9ACD32'],
        ...
        analyticsCaptureImg(document.getElementById(divId), document.getElementById('activityimg_div'));
    ...
    function getActivityDetailsHandler1(data1) {
        ...
        var mapDataObject = new Array();
        var xyArray = ['Year', 'Posts', 'Curnside Posts', 'Event Posts', 'Survey Posts', 'Promoted Posts', 'Featured Posts', 'Registrations', 'Activity Users', 'Come back Users'];
        mapDataObject.push(xyArray);
        $.each(mapData, function(key, value) {
