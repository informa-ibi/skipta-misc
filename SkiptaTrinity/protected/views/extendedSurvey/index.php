...
<!--        <div class="row-fluid">
    ...
    <?php $this->endWidget(); ?>
    <div class="pull-right" id="back-top" style="display: none">
...
<script type="text/javascript">
   $('#surveyBannerSettings,#analyticsviewcheckboxSettings,#IsCaptureUserInfo,#exNotification,#ShowDerivativecheckboxSettings').bootstrapSwitch();
