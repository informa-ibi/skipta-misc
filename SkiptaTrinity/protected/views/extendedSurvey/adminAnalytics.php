         ...
         <div class="span12">
             ...
             <div class="s_analyticsexport s_analyticsexport_global">
              ...
              <li class="dropdown analytics_export_opt" style="cursor:pointer; position: relative">
                                    <a id="drop2" data-toggle="dropdown" class="tooltiplink analytics_export " data-placement="bottom" rel="tooltip" data-original-title="Advanced Options"><i><img src="/images/system/spacer.png"><span class="fa fa-caret-down"></span></i></a>

                                    <div class="dropdown-menu analytics_export_div">

                                        <ul>

                                            <li class=""><a name="ActivityPdf" id="ActivityPdf" target="_blank" onclick="openAnalyticspdfforall()"><i><img class="pdf_doc" src="/images/system/spacer.png"></i> Export as PDF</a></li>
                                            <li class=""><a style="cursor:pointer" id="genereateXlsforAll"><i><img class="excel_doc" src="/images/system/spacer.png"></i> Export as Excel</a></li>
                    ...
                    <div class="media-status_survey">
                        ...
                        <li class="detailed"><div class="statusminibox extquestionscount">
                             ...
                             <li class="detailed"><div class="statusminibox extuserscount">
                               <span><?php echo (sizeof($scheduleObject->SurveyTakenUsers)+sizeof($scheduleObject->ResumeUsers)); ?></span>
                            </div></li>
                              ...
                              <li class="detailed"><div class="statusminibox "  >
                               ...
                               <ul class="time_spent">
	<li class="total_timespent tooltiplink" data-original-title="Total Survey Spent Time" rel="tooltip" data-placement="bottom"><?php echo $totalTimeSpent?></li>
    <li class="avg_timespent tooltiplink" data-original-title="Avg Survey Spent Time" rel="tooltip" data-placement="bottom"><?php echo $avgtimeSpent; ?></li>
</ul>
                            </div></li>
...
<!--     <div class="row-fluid groupseperator border-bottom">
     ...
     <div class="surveyareaheader surveyareaheader_analytics" >
         ...
         <div  class="positionrelative" ></div>
            <div id="quesiton_SurveyUsersPieChat" class="s_analytics_question" >Survey Users Chart</div>   
...
<div class="s_analyticsexport">
              ...
              <li style="cursor:pointer; position: relative" class="dropdown analytics_export_opt">
                                    ...
                                    <div class="dropdown-menu analytics_export_div">
                                        ...
                                        <ul>
                                            ...
                                            <li class="" ><a onclick="openAnalyticspdf(this,'','SurveyUsersPieChat', -2, 1)"  target="_blank"  id="ActivityPdf" name="ActivityPdf"><i><img src="/images/system/spacer.png"  class="pdf_doc"></i> Export as PDF</a></li>
             ...
             <div class="span4">
                 <div class="customtable">
                     <div class="customheader">
                         <div class="customcolumns">Users</div>
                          <div class="customcolumns aligncenter">Count</div>
                         
                     </div>
                     <div  class="customgroup">
                     
                         <div class="customrows">
                                     <div class="customcolumns">Users Who Completed Survey</div>                                     
                                     <div class="customcolumns" style="text-align: center">
                                         <div class="completedUsers boolean_followup tooltiplink" data-original-title="Click here to see users who are completed survey" rel="tooltip" data-placement="bottom"><?php echo sizeof($scheduleObject->SurveyTakenUsers); ?></div>
                                     </div>
                        </div>
                         <div class="customrows">
                                     <div class="customcolumns">Users Who Abandoned Survey</div>
                             <div class="customcolumns" style="text-align: center">
                                 <div class="abandonedUsers boolean_followup tooltiplink" data-original-title="Click here to see users who are abandoned survey" rel="tooltip" data-placement="bottom"><?php echo sizeof($scheduleObject->ResumeUsers); ?></div>
                             </div>
                    </div>
                     
                      <div class="customrowsfooter" >
                           <div class="customcolumns">Total</div>
                    <div class="customcolumns" style="text-align: center"><?php echo (sizeof($scheduleObject->SurveyTakenUsers)+sizeof($scheduleObject->ResumeUsers)); ?></div>
     ...
     <div class="surveyareaheader surveyareaheader_analytics" >
         <div class="s_analytics_numbers"></div>
         <div  class="positionrelative" ></div>
            <div id="quesiton_SurveyPagesBarChat" class="s_analytics_question" >Page Analytics</div> 
              ...
              <li style="cursor:pointer; position: relative" class="dropdown analytics_export_opt">
                                    ...
                                    <div class="dropdown-menu analytics_export_div">
                                        ...
                                        <ul>
                                            ...
                                            <li class="" ><a onclick="openAnalyticspdf(this,'','SurveyPagesBarChat', -1, 1)"  target="_blank"  id="ActivityPdf" name="ActivityPdf"><i><img src="/images/system/spacer.png"  class="pdf_doc"></i> Export as PDF</a></li>
     ...
     <div class="tab_1">
         <div class="row-fluid">
             ...
             <div class="span4">
                 <div class="customtable">
                     <div class="customheader">
                         <div class="customcolumns">Page Number</div>
                         <div class="customcolumns aligncenter">Time Spent</div>
                      <div class="customcolumns">Percentage</div>
...
<?php } ?> 
                      ...
                      <div class="customrowsfooter" >
                         ...
                         <div class="customcolumns">Total</div>                          
                         <div class="customcolumns aligncenter"><?php echo $PagesAnalyticsNativeData["totalTimeSpentString"] ?></div>
     ...
     <div class="tab_1">
         <div class="row-fluid">
             ...
             <div class="span4">
                 <div class="customtable">
                     <div class="customheader">
                         <div class="customcolumns aligncenter">Option&nbsp;Name</div>
                          <div class="customcolumns aligncenter">Answered Count</div>
                          <div class="customcolumns aligncenter">Percentage</div>
             ...
             <div class="span4">
                 <div class="customtable">
                     <div class="customheader">
                         <div class="customcolumns aligncenter">Users</div>
                          <div class="customcolumns aligncenter">Count</div>
                          <div class="customcolumns aligncenter">Percentage</div>
                          <?php if($question['QuestionType'] == 8) {?>
                           <div class="customcolumns">  </div>
     ...
     // google.setOnLoadCallback(drawChart);
      function drawUsersPieChart() {

        var data = google.visualization.arrayToDataTable([
          ['Task', 'Hours per Day'],
          ['Users Who Completed Survey',     <?php echo sizeof($scheduleObject->SurveyTakenUsers)?>],
          ['Users Who Abandoned Survey',     <?php echo sizeof($scheduleObject->ResumeUsers)?>],
                 ...
                 if (value.QuestionType == 1 || value.QuestionType == 2 || value.QuestionType == 5 || value.QuestionType == 8) {
                     ...
                     $.each(value.OptionsPercentageArray, function(key1, value1) {
                        ...
                        if(value.OtherValue == key1){
                           htmlstroption +='<div class="customcolumns"><a class="analyticsOtherR tooltiplink justification_followup" data-original-title="Click here to see Other data" rel="tooltip" data-placement="bottom" data-qid="'+questionId+'" data-qtype="'+value.QuestionType+'">'+substr+'</a></div>';  
                        }else{
...
//                        htmlstrvaluep += '<div class="customcolumns">'+value1+'</div>';
      ...
      var labelD = value.LabelDescription;      
       ...
       htmlstroption += '<div class="customcolumns aligncenter" >Total</div>';
        
       if(value.JustificationPlaceholders.length > 0){
            htmlstroption += '<div class="customcolumns justificationR justification_followup tooltiplink aligncenter" data-original-title="Click to see Justifications" rel="tooltip" data-placement="bottom" data-qid="'+questionId+'" data-qtype="'+value.QuestionType+'">Justfication</div>';
       }
     ...
     // alert(value.OptionsCommentsPercentageArray.toSource());
        $.each(value.OptionsPercentageArray, function( key1, value1 ) {
             var substr = key1.substr(0, 30);
                        ...
                        if(value.OtherValue == key1){
                            htmltrovalue += '<div class="customrows" ><div class="customcolumns"><a class="analyticsOtherR tooltiplink justification_followup" data-original-title="Click to see Other data" rel="tooltip" data-placement="bottom" data-qid="'+questionId+'" data-qtype="'+value.QuestionType+'">'+substr+'</a></div>'; 
                        }else{
...
var surveyUsersPage = 0;
var sjPopupAjax1 = false;
$(".completedUsers").die().live("click",function(){
    sjPopupAjax1 = false;
    var completedUsersIdsArray = '<?php echo json_encode($scheduleObject->SurveyTakenUsers); ?>';    
    var completedUsersIdsArraySize = '<?php echo sizeof($scheduleObject->SurveyTakenUsers); ?>'; 
    surveyUsersPage = 0;
    showSurveyUsers(completedUsersIdsArray, "<?php echo Yii::t('translation', 'SurveyCompletedUsers_Label') ?>", completedUsersIdsArraySize);
});

$(".abandonedUsers").die().live("click",function(){
    sjPopupAjax1 = false;
    var completedUsersIdsArray = '<?php echo json_encode($scheduleObject->ResumeUsers); ?>';
    var completedUsersIdsArraySize = '<?php echo sizeof($scheduleObject->ResumeUsers); ?>'; 
    surveyUsersPage = 0;
    showSurveyUsers(completedUsersIdsArray, "<?php echo Yii::t('translation', 'SurveyAbandonedUsers_Label') ?>", completedUsersIdsArraySize);
});

function  showSurveyUsers(surveyUsersIdsArray, title, completedUsersIdsArraySize){    
    var data = {"surveyUsersIdsArray":surveyUsersIdsArray,"Page":surveyUsersPage};
    ajaxRequest("/extendedSurvey/getSurveyCompletedUsers",data,
    function(html){
        showSurveyUsersHandler(html,surveyUsersIdsArray, title, completedUsersIdsArraySize);
    }
    ,"html");
    }
    
    function showSurveyUsersHandler(html,surveyUsersIdsArray, title, completedUsersIdsArraySize){
    ...
    if(surveyUsersPage == 0){
        ...
        if(html != 0){
            ...
            if(completedUsersIdsArraySize >= 9)
                $("#tagCloud_body").jScrollPane({autoReinitialise: true, autoReinitialiseDelay: 150, stickToBottom: true});
            ...
            $("#tagCloud_body").bind('jsp-scroll-y', function(event, scrollPositionY, isAtTop, isAtBottom)
            {
                if (isAtBottom && sjPopupAjax1 == false) {
                    surveyUsersPage++;
                      sjPopupAjax1=true;
                   showSurveyUsers(surveyUsersIdsArray, title, completedUsersIdsArraySize);
                }
            });
