...
<?php include 'CategoriesAndHashtags.php'?> 
   <div id="poststreamwidgetdiv">
    ...
    <div class="row-fluid">
    <div class="span12"  id="mainStreamPostWidget">
        ...
        <div class="pull-left whitespace">
            ...
            <ul><li class="dropdown pull-left ">
                   ...
                   <li class="dropdown pull-left" style="white-space:nowrap;cursor:pointer;">
                     <a id="drop2" data-toggle="dropdown" class="tooltiplink actionmore "  data-placement="bottom" rel="tooltip"  data-original-title="<?php echo Yii::t('translation','Advanced_Options'); ?>" ><i class="fa adv_options"><span class="fa fa-caret-down"></span></i></a>
            ...
            <div class="dropdown-menu actionmorediv" >
                ...
                <li id="<?php echo $value['Action']; ?>" class="" data-postType="<?php echo $value['Action'];?>"><a><i><img class="<?php  echo $class;?>" src="/images/system/spacer.png"></i> <?php echo Yii::t('translation',$value['Action']);;?></a></li>
                  ...
                  ?>
                <li id="Curbside" class="" data-postType="Curbside"><a><i class="fa fa-quote-left <?php  echo $class;?>"></i><?php echo " ".Yii::t('translation','CurbsideConsult') ?></a></li>
...
<?php $this->endWidget(); ?>
       ...
       <?php include 'curbside_creationForm.php' ?>
  <div class="groupseperator">
   ...
   <div id="numero1"><!-- This id numero1 is used for Joyride help -->
    <h2 class="pagetitle positionrelative searchfiltericon"><?php echo Yii::t('translation','Stream'); ?>  
         <div style=" display:none;" class="curbside_category curbsideTopicFilter" id="categoryClickedDiv">
               
            </div>
         <?php if(Yii::app()->params['Project']!='SkiptaNeo'){?>
        
        <!--This is for Curbside FIlter in Trinity -->
        <div class="filtericondiv positionrelative" >
  <div id="numero2" data-target="#crubsidefilter"  data-toggle="collapse" class="btn_toggle positionrelative">
      <i  class="fa fa-filter_new" id="c_filteractive" onclick="filtericonchange(this.id);" ></i>
      <i style="display:none" class=" fa fa-filter_new fa-filter_h_new" id="c_filterinactive" onclick="filtericonchange(this.id);"></i>
  </div>
    ...
    <div class="positionrelative padding-bottom5">
       ...
       <div class="categorymemenuhelp alignright tooltiplink" style="display:none;padding-top: 5px;"> <a  class="detailed_close " > REMOVE FILTERS</a> </div>
    </div>
             </div>
      <!--THis is for Curbside FIlter in Trinity END-->  
...
//            loadGalleria();
    ...
    <?php }}?>
        ...
        initializeFileUploader('uploadfile', '/post/upload', '10*1024*1024', extensions,'4', 'NormalPostForm' ,'',previewImage,appendErrorMessages,"uploadlist");
         initializeFileUploader('uploadfileC', '/post/upload', '10*1024*1024', extensions,4, 'CurbsidePostForm' ,'',previewImage,appendErrorMessages,'uploadlistC');
