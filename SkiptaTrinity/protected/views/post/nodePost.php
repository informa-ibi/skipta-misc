    ...
    //socket connection is established...
        ...
        socketPost.on('getLatestPostsRes', function(content) {
            if (content != 0) {
                ...
                pF1 = 1;
                ObjectA = {PF1:pF1,PF2:pF2,sCountTime:socialActionIntervalTime,storiesTime:postIntervalTime,hostName:remoteAddress,pageName:gPage,utcTime:utcTime,sessionId:sessionStorage.userSessionId};
