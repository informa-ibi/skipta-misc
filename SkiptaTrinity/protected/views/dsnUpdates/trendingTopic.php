...
<div class="dsn_notifications">
        	<div class="stream_title paddingt5lr10 bg_w"><a class="pull-left marginzero normaltext">Trending topic is</a> <a class="pull-left marginzero smallprofileicon"><?php if($topicDetails[0]->ProfileImage!=null && $topicDetails[0]->ProfileImage!='') { ?> <img src="<?php echo $topicDetails[0]->ProfileImage?>"><?php } else { ?><img src="/images/system/user_noimage.png"> <?php }?> </a> <b>  &nbsp; <?php  echo $topicDetails[0]->TopicName;?> </a> </div>
            <div class="stream_title paddingt5lr10 bg_w"><a class="pull-left marginzero smallprofileicon"><img src="<?php echo $userDetails[0]->profile70x70?> "> </a> <b><?php echo $userDetails[0]->DisplayName?></b>&nbsp;  made a Post <i><?php echo CommonUtility::styleDateTime($OriginalPostTime->sec)?> </i></div>
