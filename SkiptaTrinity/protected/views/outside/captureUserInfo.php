    ...
    <div class=" p_card">
        <div class="p_icon">
                        ...
                        <div class="marginzero smallprofileicon noBackGrUp">
                            ...
                            <div class="editicondiv editicondivProfileImage no_border ">
                ...
                <div class="span12">
                    <div class="span5">
                       ...
                       <div class="lineheight25 pull-left radiobutton ">
                            ...
                            <div class="control-group controlerror marginbottom20 " id="npistatusdiv">
                                <label class="marginbottom10"><?php echo Yii::t('translation','User_Info_NPICheck'); ?></label>
                                <?php echo $form->hiddenField($UserInfo,'NPIStatus',array("value"=>0)); ?>
                         
                                <input type="checkbox" id="npistatus_checkbox" class="styled" />
                            <div class="control-group controlerror marginbottom20 " >

                            <?php echo $form->error($UserInfo,'NPIStatus'); ?>
                    ...
                    <div class="row-fluid" id="npinumber" >
                        ...
                        <div class="span4" >
                            ...
                            <div class="span4 positionrelative">
                                <label><?php echo Yii::t('translation','User_NPIStateState'); ?></label>
                                
                                <?php   echo $form->dropDownlist($UserInfo, 'NPIState', CHtml::listData(State::model()->findAll(),'id','State'),array(
                                    'class'=>" span12 textfield ",
                                    'multiple'=>'multiple'
                                    ),array("data-id"=>1)); 
                                          ?> 
                                     <div class="control-group controlerror marginbottom10"><?php echo $form->error($UserInfo,'NPIState'); ?>
                                 </div>
                            </div>
                        </div>
                         </div>
                        <div id="npinumber_div" style="display: none;">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
       ...
       $("#npistatusdiv span.checkbox").live("click",function(){
          ...
          $("#MarketResearchFollowUpForm_NPIStatus").val(isChecked);
