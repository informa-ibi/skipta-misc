...
<div id="<?php echo str_replace(" ","",$EducationName); ?>_<?php echo $Id; ?>" data-id='<?php echo $EducationId; ?>' >
    ...
    <div class="accordion-heading">
        ...
        <div class="sectionremove" data-placement="bottom" rel="tooltip"  data-original-title="<?php echo Yii::t('translation','Remove_section'); ?>" onclick="removeSection('<?php echo $EducationId; ?>','<?php echo str_replace(" ","",$EducationName); ?>','E_dropdown','Education','<?php echo $Id; ?>')"><i class="fa fa-times"></i>
        </div>
    </div>
                ...
                <div class="span12">
                    <div class="span4">
                        ...
                        <div class="control-group controlerror marginbottom10">
                            <input type="text" name="UserCVForm[CollegeName][<?php echo $Id; ?>]" class="span12 textfield SpecialCh" maxlength="50" id="UserCVForm_CollegeName_<?php echo $Id; ?>">
                    ...
                    <div class="span4">
                        ...
                        <div class="control-group controlerror marginbottom10">
                            <input type="text" name="UserCVForm[Specialization][<?php echo $Id; ?>]" class="span12 textfield SpecialCh" maxlength="50" id="UserCVForm_Specialization_<?php echo $Id; ?>">
                    ...
                    <div class="span4 divrelative">
                        ...
                        <div data-date="" data-date-format="mm/dd/yyyy" class="input-append date " id="Education_Year_<?php echo $Id; ?>">
                            <input type="text" name="UserCVForm[YearOfPassing][<?php echo $Id; ?>]" class="span12 textfield SpecialCh"  maxlength="50" id="UserCVForm_YearOfPassing_<?php echo $Id; ?>"> 
