...
<!-------------------------------------------------------------Education---------------------------------------------------------->           
<div id="educationdragdiv" class=" childCvbtn"  data-priority='0'>
<div class="row-fluid">
        ...
        <div class="cvaccordian">
            <div class="cvoutergroup">
                <div class="cvaccordian-heading">
                    ...
                    <div class="addsection " id="E_dropdown-sec"><span id="E_dropdown-toggle" class="dropdown-toggle dropdownsection"  role="button" data-toggle="dropdown" data-target="#"><?php echo Yii::t('translation','Add_Section'); ?></span>
                            ...
                            <div class="accordion-group">
                                <div class="accordion-heading ">
                                    <a class="accordion-toggle EducationClass" data-toggle="collapse" data-parent="#accordion1" href="#collapseOne">
                                        <?php echo Yii::t('translation','Graduation'); ?>
                                    </a>
                                                ...
                                                <div class="span12">
                                                    <div class="span4">
                                                        ...
                                                        <div class="control-group controlerror marginbottom10">
                                                            <?php echo $form->textField($UserCVForm, 'CollegeName['.$EducationId.']', array("id" => "UserCVForm_CollegeName_$EducationId", 'maxlength' => '50', 'class' => 'span12 textfield SpecialCh')); ?>
                                                    ...
                                                    <div class="span4">
                                                        ...
                                                        <div class="control-group controlerror marginbottom10">
                                                            <?php echo $form->textField($UserCVForm, 'Specialization['.$EducationId.']', array("id" => "UserCVForm_Specialization_$EducationId", 'maxlength' => '50', 'class' => 'span12 textfield SpecialCh')); ?>
                                                    ...
                                                    <div class="span4 divrelative">
                                                        ...
                                                        <label><?php echo Yii::t('translation', 'User_Cv_Education_Graduation_Year'); ?></label>
                                                        <div id="Education_Year_<?php echo $EducationId; ?>" class="input-append date" data-date-format="<?php echo Yii::app()->params['DateFormat']; ?>" data-date="">
                                                            <?php echo $form->textField($UserCVForm, 'YearOfPassing['.$EducationId.']', array("id" => "UserCVForm_YearOfPassing_$EducationId", 'maxlength' => '50', 'class' => 'span12 textfield SpecialCh')); ?>
...
<!----------------------------------------Experience -------------------------------------------------------->
<div id="experiencedragdiv" class="childCvbtn" data-priority='1' >
<div class="row-fluid">
    <div class="span9 customaccordian">
        <div class="cvaccordian">
            <div class="cvoutergroup">
                <div class="cvaccordian-heading">
                    ...
                    <div class="addsection "><span id="EX_dropdown-toggle" class="dropdown-toggle dropdownsection"  role="button" data-toggle="dropdown" data-target="#"><?php echo Yii::t('translation','Add_Section'); ?></span>
...
<!------------------------------------------------------------- Interests ------------------------------------------------------->
<div id="interestsdragdiv" class="childCvbtn" data-priority='2'  >
        ...
        <div class="cvaccordian">
            <div class="cvoutergroup">
                <div class="cvaccordian-heading">
                    ...
                    <div class="addsection "><span id="In_dropdown-toggle" class="dropdown-toggle dropdownsection"  role="button" data-toggle="dropdown" data-target="#"><?php echo Yii::t('translation','Add_Section'); ?></span>
                        <div class="dropdown-menu dropdown-menuaddsection">
                           <div id="In_dropdown" >
                            <ul aria-labelledby="drop2" role="menu">
...
<!--------------------------------------------------------------Publications ----------------------------------------------------------------------------------------->
<div id="publicationsdragdiv" class="childCvbtn"  data-priority='3'>    
    <div class="row-fluid">
 <div class="span9 customaccordian">
        <div class="cvaccordian">
            <div class="cvoutergroup">
                <div class="cvaccordian-heading">
                    <div class="cvaccordion-toggle "><span class="subdivdragClass cvaccordion-toggle2 publications" style="cursor: pointer" ><?php echo Yii::t('translation','Publications'); ?></span></div>
                     <div class="addsection "><span class="dropdown-toggle dropdownsection"  onclick="addOneMorePublication()" role="button" ><?php echo Yii::t('translation','Add_Section'); ?></span>
...
<!--------------------------------------------------------------Achievements ----------------------------------------------------------------------------------------->
<div id="Achievementsdragdiv" class="childCvbtn"  data-priority='4' >      
<div class="row-fluid">
    <div class="span9 customaccordian">
        <div class="cvaccordian">
            <div class="cvoutergroup">
                <div class="cvaccordian-heading">
                    ...
                    <div class="addsection "><span id="Am_dropdown-toggle" class="dropdown-toggle dropdownsection" role="button" data-toggle="dropdown" data-target="#"><?php echo Yii::t('translation','Add_Section'); ?></span>
                        <div class="dropdown-menu dropdown-menuaddsection">
                            <div id="Am_dropdown" >
                                <ul aria-labelledby="drop2" role="menu">
