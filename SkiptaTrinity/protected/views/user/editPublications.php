...
<?php echo $form->hiddenField($UserCVForm, 'RecentupdateSection'); ?> 
    ...
    <?php echo $form->hiddenField($UserCVForm, 'EducationPriority'); ?> 
    <?php echo $form->hiddenField($UserCVForm, 'ExperiencePriority'); ?> 
    <?php echo $form->hiddenField($UserCVForm, 'InterestsPriority'); ?> 
    <?php echo $form->hiddenField($UserCVForm, 'PublicationsPriority'); ?> 
    <?php echo $form->hiddenField($UserCVForm, 'AchievementsPriority'); ?> 
...
<div id="educationdragdiv" class=" childCvbtn" style="cursor: pointer;" data-priority='<?php echo $CvPriorityArray['education']; ?>'>
<div class="row-fluid">
    <div class="span9 customaccordian">
        <div class="cvaccordian">
            <div class="cvoutergroup">
                <div class="cvaccordian-heading">
                    <div class="cvaccordion-toggle"><span class="subdivdragClass cvaccordion-toggle2 education" style="cursor: pointer;"><?php echo Yii::t('translation','Education'); ?></span></div>
                    <?php   if($data['education']!="failure" ){ ?>
                    <div class="addsection "><span id="E_dropdown-toggle" style="display:<?php echo  sizeof($data['education'])>0?'block':'none'; ?>" class="dropdown-toggle dropdownsection" role="button" data-toggle="dropdown" data-target="#"><?php echo Yii::t('translation','Add_Section'); ?></span>
             ...
             <div id="<?php echo str_replace(" ","",$value['Education']); ?>_<?php echo $value['EducationId']; ?>" data-id='<?php echo $value['Id']; ?>' class="educationchild">
                            <div class="accordion-group">
                                <div class="accordion-heading ">
                                    ...
                                    <div  class="sectionremove"  data-placement="bottom" rel="tooltip"  data-original-title="<?php echo Yii::t('translation','Remove_section'); ?>" onclick="removeSection('<?php echo $value['EducationId']; ?>','<?php echo str_replace(" ","",$value['Education']); ?>','E_dropdown','Education','<?php echo $value['Id']; ?>')"><i class="fa fa-times"></i>
                                    </div>
                                                ...
                                                <div class="span12">
                                                    <div class="span4">
                                                        ...
                                                        <div class="control-group controlerror marginbottom10">
                                                            <?php echo $form->textField($UserCVForm, 'CollegeName['.$value['Id'].']', array("id" => 'UserCVForm_CollegeName_'.$value['Id'], value=>$value['CollegeName'],'maxlength' => '50', 'class' => 'span12 textfield SpecialCh')); ?>
                                                    ...
                                                    <div class="span4">
                                                        ...
                                                        <div class="control-group controlerror marginbottom10">
                                                            <?php echo $form->textField($UserCVForm, 'Specialization['.$value['Id'].']', array("id" => 'UserCVForm_Specialization_'.$value['Id'], value=>$value['Specialization'],'maxlength' => '50', 'class' => 'span12 textfield SpecialCh')); ?>
                                                    ...
                                                    <div class="span4 divrelative">
                                                        ...
                                                        <label><?php if($value['Education']=="Graduation" ||  $value['Education']=="Graduate" ){ ?> <?php echo Yii::t('translation', 'User_Cv_Education_Graduation_Year'); ?> <?php }else{ ?><?php echo Yii::t('translation', 'User_Cv_Education_Year'); ?>  <?php } ?></label>
                                                        <div id="Education_Year_<?php echo $value['Id']; ?>" class="input-append date" data-date-format="<?php echo Yii::app()->params['DateFormat']; ?>" data-date="">
                                                            <?php echo $form->textField($UserCVForm, 'YearOfPassing['.$value['Id'].']', array("id" => 'UserCVForm_YearOfPassing_'.$value['Id'], value=>$value['YearOfPassing'],'maxlength' => '50', 'class' => 'span12 textfield SpecialCh')); ?>
    ...
    <div class='span3'>
        <!-- start -->
        <div class="profile_helpbox" style='margin-bottom: 10px;'>
            <label class="title">Expand on your educational experience.</label>

            <label class="sub_title">Choose from:</label>
...
<div id="experiencedragdiv" class=" childCvbtn" style="cursor: pointer;" data-priority='<?php echo $CvPriorityArray['experience']; ?>'>
<div class="row-fluid">
    <div class="span9 customaccordian">
        <div class="cvaccordian">
            <div class="cvoutergroup">
                <div class="cvaccordian-heading">
                    <div class="cvaccordion-toggle"><span class="subdivdragClass cvaccordion-toggle2 experience" style="cursor: pointer;"><?php echo Yii::t('translation','Experience'); ?></span></div>
                     <?php  if($data['experience']!="failure" ){ ?>
                    <div class="addsection "><span id="EX_dropdown-toggle"  style="display:<?php echo  sizeof($data['experience'])>0?'block':'none'; ?>" class="dropdown-toggle dropdownsection" role="button" data-toggle="dropdown" data-target="#"><?php echo Yii::t('translation','Add_Section'); ?></span>
                        <div class="dropdown-menu dropdown-menuaddsection">
                             <div id="EX_dropdown" >
                            <ul aria-labelledby="drop2" role="menu">
                             <?php 
                        ...
                        <div class="accordion" id="accordion2">
                            ...
                            <?php   echo $form->hiddenField($UserCVForm, 'UserExperience['.$value['ExperienceId'].']'); ?>
                                ...
                                <div class="accordion-heading">
                                    ...
                                    <div class="sectionremove" data-placement="bottom" rel="tooltip"  data-original-title="<?php echo Yii::t('translation','Remove_section'); ?>" onclick="removeSection('<?php echo $value['ExperienceId']; ?>','<?php echo str_replace(" ","",$value['Experience']); ?>','EX_dropdown','Experience','<?php echo $value['Id']; ?>')"><i class="fa fa-times"></i>
                                    </div>
                                </div>
...
<!--------------end-------------------------------------------------------------------------------->
    ...
    <div class='span3' style='margin-bottom: 10px;'>
         <div class="profile_helpbox">
         <label class="title">Share your professional, research, academic and volunteer experiences here.</label>
        </div>
    </div>
</div>
</div>
...
<div id="interestsdragdiv" class="childCvbtn" style='cursor: pointer;' data-priority='<?php echo $CvPriorityArray['interests']; ?>'>
...
<div class="row-fluid">
    <div class="span9 customaccordian">
        <div class="cvaccordian">
            <div class="cvoutergroup">
                <div class="cvaccordian-heading">
                    <div class="cvaccordion-toggle"><span class="subdivdragClass cvaccordion-toggle2 intrests" style="cursor: pointer;"><?php echo Yii::t('translation','Interests'); ?></span></div>
                    <?php  if($data['interests']!="failure"){ ?>
                    <div class="addsection "><span id="In_dropdown-toggle"  style="display:<?php echo  sizeof($data['interests'])>0?'block':'none'; ?>" class="dropdown-toggle dropdownsection"  role="button" data-toggle="dropdown" data-target="#"><?php echo Yii::t('translation','Add_Section'); ?></span>
                        <div class="dropdown-menu dropdown-menuaddsection">
                           <div id="In_dropdown" >
                            <ul aria-labelledby="drop2" role="menu">
                            ...
                            <div class="accordion-group">
                                <div class="accordion-heading">
                                    <a  class="accordion-toggle InterestsClass" data-toggle="collapse" data-parent="#accordion3" href="#collapseThree">
                                     <?php echo str_replace("Interests"," Interests",$value['Interests']);  ?> <i data-original-title="<?php echo Yii::t('translation','Type_And_Press_Enter_Button'); ?>" rel="tooltip" data-placement="bottom" data-id="id" style="font-weight: normal;top:7px;right:auto;float:left;margin-left:5px;" class="fa fa-question helpmanagement helpicon top10  tooltiplink"></i>
                                    </a>
                                    <div class="sectionremove"  data-placement="bottom" rel="tooltip"  data-original-title="<?php echo Yii::t('translation','Remove_section'); ?>" onclick="removeSection('<?php echo $value['InterestId']; ?>','<?php echo str_replace(" ","",$value['Interests']); ?>', 'In_dropdown', 'Interests','<?php echo $value['Id']; ?>')"><i class="fa fa-times"></i>
                                    </div>
                                </div>
...
<!--                                           <label >PersonalINterests</label>-->
                                            <div class="padding-bottom5">
                                               ...
                                               <div class="control-group controlerror marginbottom10">
                                                   <?php echo $form->textField($UserCVForm, 'UserInterests['.$value['InterestId'].']', array("id" => "UserCVForm_UserInterests_".$value['InterestId'], 'maxlength' => '50', 'onkeyup' => 'PublicationAuthors(event,this,"Interests")','value'=> $value['Tags'],'class' => 'span12 textfield')); ?>
...
<!-------------------------------------End------------------------------------------------------------------------------->
    ...
    <div class='span3' style='margin-bottom: 10px;'>
         <div class="profile_helpbox">
         <label class="title">Add your academic, personal and research interests.</label>
        </div>
    </div>
</div
</div>
...
<div id="e_publicationsdiv"  > 
 <div id="publicationsdragdiv" class="childCvbtn" style="cursor: pointer;" data-priority='<?php echo $CvPriorityArray['publications']; ?>'>          
...
<div class="row-fluid">
    <div class="span9 customaccordian">
        <div class="cvaccordian">
            <div class="cvoutergroup">
                <div class="cvaccordian-heading">
                    <div class="cvaccordion-toggle"><span class="subdivdragClass cvaccordion-toggle2 publications" style="cursor: pointer;"><?php echo Yii::t('translation','Publications'); ?></span></div>
                     <div class="addsection " data-placement="bottom" rel="tooltip"  data-original-title="<?php echo Yii::t('translation','Add_section_to_Publications'); ?>"><span class="dropdown-toggle dropdownsection"  onclick="addOneMorePublication()" role="button" ><?php echo Yii::t('translation','Add_Section'); ?></span>
              ...
              <?php echo $form->hiddenField($UserCVForm, 'Publicationfile['.$value['Id'].']'); ?> 
                            <div class="accordion-group">
                                <div class="accordion-heading">
                                    ...
                                    <div class="sectionremove" data-placement="bottom" rel="tooltip"  data-original-title="<?php echo Yii::t('translation','Remove_section'); ?>" onclick="removePublication('<?php echo $value['Id']; ?>')"><i class="fa fa-times"></i>
                                    </div>
                                </div>
                                                ...
                                                <div class="span12">
                                                    <div class="span4">
                                                        ...
                                                        <div class="control-group controlerror marginbottom10">
                                                            ...
                                                            <?php echo $form->textField($UserCVForm, 'PublicationName['.$value['Id'].']', array("id" => 'UserCVForm_PublicationName_'.$value['Id'], 'maxlength' => '30', 'value'=>$value['Name'],'class' => 'tooltiplink span12 textfield SpecialCh')); ?>
                                                    ...
                                                    <div class="span4">
                                                        ...
                                                        <div class="control-group controlerror marginbottom10">
                                                            <?php echo $form->textField($UserCVForm, 'PublicationTitle['.$value['Id'].']', array("id" => 'UserCVForm_PublicationTitle_'.$value['Id'], 'maxlength' => '30', 'value'=>$value['Title'],'class' => 'tooltiplink span12 textfield SpecialCh')); ?>
                                                    ...
                                                    <div class="span4">
                                                        ...
                                                        <label><?php echo Yii::t('translation', 'User_Publication_Date'); ?></label>
                                                         ...
                                                         <div id="publication_Date_0" class="input-append date" data-date-format="<?php echo Yii::app()->params['DateFormat']; ?>" data-date="">
                                                             ...
                                                             <?php echo $form->textField($UserCVForm, 'PublicationDate['.$value['Id'].']', array("id" => 'UserCVForm_PublicationDate_'.$value['Id'], 'maxlength' => '30', 'value'=>$value['PublicationDate'], 'class' => 'tooltiplink span12 textfield SpecialCh')); ?>
                                        ...
                                        <div class="row-fluid padding8top">
                                                <div class="span12">
                                                    <div class="span4">
                                                        ...
                                                        <div class="control-group controlerror marginbottom10">
                                                            <?php echo $form->textField($UserCVForm, 'PublicationLocation['.$value['Id'].']', array("id" => 'UserCVForm_PublicationLocation_'.$value['Id'], 'maxlength' => '50', 'value'=>$value['Location'], 'class' => 'tooltiplink span12 textfield SpecialCh')); ?>
                                                    ...
                                                    <div class="span5">
                                                        ...
                                                        <div class="control-group controlerror marginbottom10">
                                                            <?php echo $form->textField($UserCVForm, 'PublicationLink['.$value['Id'].']', array("id" => 'UserCVForm_PublicationLink_'.$value['Id'], 'maxlength' => '250','value'=>$value['Link'], 'class' => 'tooltiplink span12 textfield SpecialCh')); ?>
...
<!---------------------------------------------endPublicationss--------------------------------------------------------------->
    ...
    <div class='span3' style='margin-bottom: 10px;'>
        <div class="profile_helpbox">
         <label class="title">You’re able to share your publications here. Add each with a link or upload a copy.</label>
        </div>
    </div> 
...
<div id="Achievementsdragdiv" class=" childCvbtn"  style='cursor: pointer;' data-priority='<?php echo $CvPriorityArray['achievements']; ?>' >
    ...
    <div class="span9 customaccordian">
        <div class="cvaccordian">
            <div class="cvoutergroup">
                <div class="cvaccordian-heading">
                    <div class="cvaccordion-toggle"><span class="subdivdragClass cvaccordion-toggle2 achievements" style="cursor: pointer;"><?php echo Yii::t('translation','Achievements'); ?></span></div>
                      <?php  
                      if($data['achievements']!="failure" ){ ?>
                    <div class="addsection "><span id="Am_dropdown-toggle" style="display:<?php echo  sizeof($data['achievements'])>0?'block':'none'; ?>" class="dropdown-toggle dropdownsection" role="button" data-toggle="dropdown" data-target="#"><?php echo Yii::t('translation','Add_Section'); ?></span>
                        <div class="dropdown-menu dropdown-menuaddsection">
                            <div id="Am_dropdown" >
                                <ul aria-labelledby="drop2" role="menu">
        ...
        <?php echo $form->hiddenField($UserCVForm, 'UserAchievements['.$value['AchievementId'].']');  ?> 
                            <div class="accordion-group">
                                <div class="accordion-heading">
                                    ...
                                    <div class="sectionremove" data-placement="bottom" rel="tooltip"  data-original-title="<?php echo Yii::t('translation','Remove_section'); ?>" onclick="removeSection('<?php echo $value['AchievementId']; ?>','<?php echo $value['Achievement']; ?>', 'Am_dropdown', 'Achievements','<?php echo $value['Id']; ?>')"><i class="fa fa-times"></i>
                                    </div>
                                </div>
...
<!-----------------------------------------------------End----------------------------------------------------------------->
         ...
         <div class='span3' style='margin-bottom: 10px;'>
            <div class="profile_helpbox">
              <label class="title">Your achievements are important. Post them here, along with presentations, awards and grants you’ve received. </label>
            </div>
         </div>
</div>
...
<script type="text/javascript"> 
    g_OrderArray = <?php echo json_encode($OrderArray); ?>;
     for (var r = 0; r < g_OrderArray.length; r++) {
         $("#subdiv_"+r).html($("#"+g_OrderArray[r]).html());
         $("#"+g_OrderArray[r]).html("");
     }
...
$("[rel=tooltip]").tooltip();
  ...
  $(".SpecialCh").live('keypress',function(e){           
            var keyCode =e.which;            
...
for (var i = 0; i < g_Interests.length; i++) {
    ...
    for (var j = 0; j < globalInterestsArray.length; j++) {
         initializeInterestsForCV("#UserCVForm_UserInterests_"+g_Interests[i]);
...
initializeInterestsForCV("#UserCVForm_UserInterests_"+experienceId);
UpdateEducationDropdown(id,div,category);
//Custom.clear();
...
for (var i = 0; i < g_Interests.length; i++){  
    ...
    if($.trim($('#UserCVForm_UserInterests_'+g_Interests[i]).val())!=""){
        CVInterests('#UserCVForm_UserInterests_'+g_Interests[i],'Interests');
    }
     ...
     for (var i = 0; i < g_Interests.length; i++){  
        // alert("inttttttttttttttttttt"+globalspace["cv_custom_mention_UserCVForm_UserInterests_"+g_Interests[i]]);
...
$('#UserCVForm_EducationPriority').val($('#educationdragdiv').attr('data-priority'));
$('#UserCVForm_ExperiencePriority').val($('#experiencedragdiv').attr('data-priority'));
$('#UserCVForm_InterestsPriority').val($('#interestsdragdiv').attr('data-priority'));
$('#UserCVForm_PublicationsPriority').val($('#publicationsdragdiv').attr('data-priority'));
$('#UserCVForm_AchievementsPriority').val($('#Achievementsdragdiv').attr('data-priority'));
...
//            forcePlaceholderSize: true,
            opacity: 1.8,
             stop: function (event, ui) {
                ...
                $('.childCvbtn').each(function(key,value){
                             $(this).attr('data-priority',key);
                    });     
            }
