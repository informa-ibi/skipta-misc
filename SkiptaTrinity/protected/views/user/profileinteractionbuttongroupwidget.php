...
<div class="row-fluid">
    ...
    <div class="profileBar">
     ...
     <ul class="profilesocial profilesocialcv pull-left">
         <li> <span style="cursor: pointer;padding-left:7px;" data-original-title="<?php echo Yii::t('translation','Followers'); ?>" rel="tooltip" data-placement="bottom" class="tooltiplink p_followers"><img src="/images/system/spacer.png"><i id="p_followersCount"><?php echo $profileDetails->UserFollowersCount ?></i></span></li>
     <li> <span style="cursor: pointer;" data-original-title="<?php echo Yii::t('translation','Following'); ?>" rel="tooltip" data-placement="bottom" class="tooltiplink p_following"><img src="/images/system/spacer.png"><i id="p_followingCount"><?php echo $profileDetails->UserFollowingCount ?></i></span></li>
     <?php  if($IsUser != 1){?>
     <li> 
         ...
         <?php }else{ ?>
        <span data-placement="bottom" id="userFollowunfollowa_<?php  echo $profileDetails->UserId;?>" rel="tooltip" style="cursor: pointer" <?php  if(empty($profileDetails->IsFollowed)){ ?> data-original-title="<?php echo Yii::t('translation','Follow'); ?>" <?php }else{?>  data-original-title="<?php echo Yii::t('translation','UnFollow'); ?>"  <?php }?> class="tooltiplink <?php  if($profileDetails->IsFollowed==0){ echo 'p_unfollowbig'; }else{ echo 'p_followbig'; }?>">
