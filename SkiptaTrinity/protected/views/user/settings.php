              ...
              <div class="row-fluid padding-bottom10">
                ...
                <div class="span6 divrelative" id="registartion_country">
                    ...
                    <label><?php echo Yii::t('translation','User_Register_Country'); ?></label>
                     ...
                     <?php
                        echo $form->dropDownlist($UserRegistrationForm, 'state',CHtml::listData(State::model()->findAllByAttributes(array("CountryId"=>$UserRegistrationForm->country)),'StateCode','State'),array('selected'=>$stateId),array(
                        'class'=>"styled span12 textfield",
 ...
 function registercallback(data) { 
     scrollPleaseWaitClose('registrationSpinLoader');
        ...
        if (data.status == 'success') {
            ...
            var displayName = data.tinyObject.DisplayName;
         var uniqueHandle = data.tinyObject.uniqueHandle;         
        $("#UserDisplayName").html(displayName);
        $("#userProfileLink").attr("href","/profile/"+uniqueHandle);
            var msg = data.data;
    ...
    function updatesettingscallback(data) {
      ...
      breadCumSource = "Settings";
sessionStorage.breadCumSource = "Settings";
</script>
