...
<div class="padding10ltb">
    ...
    <div class="market_profile marginT10">
        <div class="m_profileicon" id="notsafaribrowser" style="display: none;">
...
<!--                                <img id="profileImagePreviewId" src="" alt="" />-->
        ...
        <div class="m_profileicon" id="safaribrowser" style="display: none;">
        <div class="safariicon safari_largeicon" >
  <div class="safariiconinner">
   <img alt="" src="<?php echo $surveyObj->SurveyLogo; ?>" >
 </div>
</div>
        </div>
...
if (navigator.userAgent.indexOf('Safari') != -1 ) {
    <?php $safari = "true"; ?>
                ...
                $("#notsafaribrowser").hide();
                 $("#safaribrowser").show();
                
}else{
    $("#notsafaribrowser").show();
    $("#safaribrowser").hide();
}
</script>
