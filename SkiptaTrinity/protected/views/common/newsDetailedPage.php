     ...
     if($data->IsAbused == 1 || $data->IsDeleted == 1 || $data->IsBlockedWordExist == 1){ ?>
        <div class="row-fluid">
            <div class="span12" style="text-align:center;font-family:'exo_2.0medium'">
                <h3><?php echo Yii::t('translation','Sorry'); ?>, <?php echo Yii::t('translation','news_item_cannot_be_shown'); ?></h3>
            </div>
        </div>
   <?php }else{
?>
...
<div class="stream_widget marginT10 positionrelative" >
    ...
    <div class="post_widget" data-postid="<?php  echo $data->_id ?>">
    ...
    <?php //include Yii::app()->basePath . '/views/post/stream_header.php'; ?>
            ...
            <div class="stream_title paddingt5lr10 stream_sectionheader" style="position: relative">
               <b><?php echo $tinyObject->DisplayName; ?></b>
    <?php  echo $StreamMessage;  ?>
...
<div class="custfrom "><a href="<?php echo $data->PublisherSourceUrl?>" target="_blank"><?php echo $data->PublisherSource?></a> - <a class="ntime" style="cursor:default;text-decoration:none"><?php echo CommonUtility::styleDateTime(strtotime($data->PublicationDate));?></a>
    <div class="nright" style="text-align:right"><?php echo Yii::t('translation','via'); ?> <a style="cursor:default;text-decoration:none">Scoop.it!</a></div>
</div>
</div>
...
<div class="social_bar social_bar_detailed"  data-id="<?php  echo $data->_id ?>" data-postid="<?php  echo $data->_id ?>" data-categoryType="<?php  echo $categoryType;?>" data-networkId="<?php  echo $data->NetworkId; ?>">	
                ...
                <a style="display: none;"><i><img src="/images/system/spacer.png" class="tooltiplink share cursor" data-placement="bottom" rel="tooltip"  data-original-title="<?php echo Yii::t('translation','Share'); ?>" ></i></a>
  ...
  <?php   if(!$data->DisableComments){
      ...
      ?>
                <span><i><img src="/images/system/spacer.png" data-placement="bottom" rel="tooltip"  data-original-title="<?php echo Yii::t('translation','Comment'); ?>" class="detailedComment tooltiplink cursor  <?php   if($data->Type!=5){?><?php echo $IsCommented?'commented':'comments'?><?php  }else{?><?php echo $IsCommented?'commented':'comments1'?><?php  }?>"  id="news_detailedComment"  data-postid="<?php  echo $data->_id ?>"></i><b id="det_commentCount_<?php  echo $data->_id ?>"><?php  echo $count; ?></b></span>
                  <?php  }?>              </div>
<?php?>
